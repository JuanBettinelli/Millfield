...
index((r_open), 0, r_session, 'R').
index((r_open), 1, r_session, 'R').
index((r_close), 0, r_session, 'R').
index((r_close), 1, r_session, 'R').
index((r_in), 1, r_session, 'R').
index((r_in), 2, r_session, 'R').
index((r_push), 1, r_session, 'R').
index((r_push), 2, r_session, 'R').
index((r_out), 2, r_session, 'R').
index((r_out), 3, r_session, 'R').
index((r_err), 3, r_session, 'R').
index((r_err), 4, r_session, 'R').
index((r_print), 1, r_session, 'R').
index((r_print), 2, r_session, 'R').
index((r_lines_print), 1, r_session, 'R').
index((r_lines_print), 2, r_session, 'R').
index((r_lines_print), 3, r_session, 'R').
index((r_lib), 1, r_session, 'R').
index((r_lib), 2, r_session, 'R').
index((r_flush), 0, r_session, 'R').
index((r_flush), 1, r_session, 'R').
index((r_flush_onto), 2, r_session, 'R').
index((r_flush_onto), 3, r_session, 'R').
index((current_r_session), 1, r_session, 'R').
index((current_r_session), 3, r_session, 'R').
index((default_r_session), 1, r_session, 'R').
index((r_session_data), 3, r_session, 'R').
index((r_streams_data), 3, r_session, 'R').
index((r_history), 0, r_session, 'R').
index((r_history), 1, r_session, 'R').
index((r_history), 2, r_session, 'R').
index((r_session_version), 1, r_session, 'R').
index((r_bin), 1, r_session, 'R').
index((r_bin_version), 1, r_session, 'R').
index((r_bin_version), 2, r_session, 'R').
index((r_verbosity), 1, r_session, 'R').
