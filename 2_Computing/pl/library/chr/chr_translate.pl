...
chr_translate_line_info(A, B, Q) :-
	...
	append(G, H, I),
	chr_analysis(I, F, C),
	time('constraint code generation', chr_translate:constraints_code(F, L)),
	time('validate store assumptions', chr_translate:validate_store_type_assumptions(F)),
	phase_end(validate_store_type_assumptions),
	used_states_known,
	time('store code generation', chr_translate:store_management_preds(F, K)),
...
chr_analysis(A, C, D) :-
	...
	time('assume constraint stores', chr_translate:assume_constraint_stores(C)),
	time('default constraint indices', chr_translate:set_constraint_indices(C)),
	time('check storedness assertions', chr_translate:check_storedness_assertions(C)),
	time('continuation analysis', chr_translate:continuation_analysis(C)).
...
add_head_occurrences(simplification(B), ids(C, _), A) :-
	maplist(add_constraint_occurrence(A, simplification), B, C).
add_head_occurrences(propagation(B), ids(_, C), A) :-
	maplist(add_constraint_occurrence(A, propagation), B, C).
add_head_occurrences(simpagation(B, D), ids(C, E), A) :-
	maplist(add_constraint_occurrence(A, simplification), B, C),
	maplist(add_constraint_occurrence(A, propagation), D, E).
...
activate_constraint_body(A, K, L, N, B, C, S) :-
	...
	;   get_dynamic_suspension_term_field(arguments, A, B, M, O),
	    generate_indexed_variables_body(A, M, P, N),
	    chr_none_locked(N, Q),
	    if_used_state(A, not_stored_yet, (J==not_stored_yet->O, P, Q, K;L), L, R)
	),
	S= (T, U, V, H, R).
...
insert_constraint_body(multi_store(C), A, B, G, E) :-
	maplist(insert_constraint_body1(A, B), C, F, D),
	list2conj(D, E),
...
delete_constraint_body(multi_store(E), A, B, C, D, G) :-
	maplist(delete_constraint_body1(A, B, C, D), E, F),
	list2conj(F, G).
delete_constraint_body1(B, C, D, E, A, F) :-
	delete_constraint_body(A, B, C, D, E, F).
...
multi_inthash_via_lookups([B|H], A, E, J) :-
	...
	multi_hash_lookup_body(A, inthash, B, C, D, G),
	E=[ (F:-G)|I],
...
multi_hash_lookup_body(A, K, B, D, G, E) :-
	...
	->  multi_hash_store_name(A, B, F),
	    make_get_store_goal(F, N, L),
	    (   K==hash,
		specialized_hash_term_call(A, B, D, O, M)
...
multi_hash_lookup_goal(B, F, C, A, G, H) :-
	...
	delay_phase_end(validate_store_type_assumptions, multi_hash_lookup_body(B, F, C, A, G, H)).
multi_hash_lookup_name(B/C, A, E) :-
	atom_concat_list(A, D),
	atom_concat_list(['$via1_multi_hash_', B, '___', C, -, D], E).
multi_hash_store_name(C/D, A, F) :-
	get_target_module(B),
	atom_concat_list(A, E),
	atom_concat_list(['$chr_store_multi_hash_', B, '____', C, '___', D, -, E], F).
multi_hash_key(C, A, D, F, E) :-
	(   A=[B]
	->  get_dynamic_suspension_term_field(argument(B), C, D, E, F)
	;   maplist(get_dynamic_suspension_term_field1(C, D), A, G, H),
	    E=..[k|G],
	    list2conj(H, F)
	).
...
multi_hash_key(_, B, A, D, C, G, F) :-
	(   A=[E]
	->  get_suspension_argument_possibly_in_scope(B, C, D, E, F, G)
	;   maplist(get_suspension_argument_possibly_in_scope(B, C, D), A, H, I),
	    F=..[k|H],
	    list2conj(I, G)
	).
get_suspension_argument_possibly_in_scope(B, I, N, A, F, G) :-
	...
	;   functor(B, K, L),
	    M=K/L,
	    get_dynamic_suspension_term_field(argument(A), M, N, F, G)
	).
...
constants_store_name(D/E, B, A, H) :-
	...
	term_to_atom(A, G),
	term_to_atom(B, F),
	atom_concat_list(['$chr_store_constants_', C, '____', D, '___', E, '___', F, '___', G], H).
constants_store_index_name(C/D, A, F) :-
	get_target_module(B),
	term_to_atom(A, E),
	atom_concat_list(['$chr_store_constants_', B, '____', C, '___', D, '___', E], F).
...
trie_step(C, K, L, A, J, M, N) :-
	A=[B|_],
	length(B, G),
	aggregate_all(set(E/F), (member(D, C), functor(D, E, F)), H),
	I is G+1,
	trie_step_cases(H, I, C, A, J, K, L, M, N).
trie_step_cases([], _, _, _, _, _, _, A, A).
trie_step_cases([A|I], B, C, D, E, F, G, H, K) :-
	trie_step_case(A, B, C, D, E, F, G, H, J),
	trie_step_cases(I, B, C, D, E, F, G, J, K).
trie_step_case(H/I, B, P, S, Q, D, B1, [A|M], N) :-
	...
	->  M=N,
	    O=true,
	    rec_cases(P, _, Q, H/I, _, _, R),
	    R=[L]
	;   rec_cases(P, S, Q, H/I, U, T, R),
	    (   T=[V]
	    ->  M=N,
		O=true,
		append([U, V, R], K)
...
rec_cases([A|L], [E|M], [K|N], B/C, F, H, J) :-
	...
	->  F=[G|O],
	    H=[I|P],
	    J=[K|Q],
	    rec_cases(L, M, N, B/C, O, P, Q)
	;   rec_cases(L, M, N, B/C, F, H, J)
	).
...
gct_(A, B, G, K, L) :-
	...
	->  functor(G, C, E),
	    ...
	    B=..[_|I],
	    G=..[_|J],
	    maplist_dcg(chr_translate:gct_, H, I, J, K, L)
	;   lookup_eq(K, A+B, G)
	->  L=K
	;   L=[A+B-G|K]
	).
...
prolog_global_variables_code(B) :-
	...
	(   A==[]
	->  B=[]
	;   maplist(wrap_in_functor('$chr_prolog_global_variable'), A, D),
...
enumerate_store_bodies([A|N], F, J) :-
	...
	->  get_store_type(A, B),
	    ...
	    get_dynamic_suspension_term_field(arguments, A, C, E, H),
	    A=D/_,
	    I=..[D|E],
...
enumerate_store_body(atomic_constants(C, D, A), B, H, F) :-
	A==complete,
	maplist(enumerate_constant_store_body(B, C, I), D, E),
	list2disj(E, G),
	F= (G, member(H, I)).
...
static_type_check_rule(F, A) :-
	A=ast_rule(B, _, _, C, _),
	(   catch((ast_static_type_check_head(B), ast_static_type_check_body(C)), type_error(D), (D=invalid_functor(E, G, H)->chr_error(type_error, 'Invalid functor in ~@ of ~@:\n\t\tfound `~w\',\n\t\texpected type `~w\'!\n', [chr_translate:format_src(E), format_rule(F), G, H]);D=type_clash(I, K, M, J, L)->chr_error(type_error, 'Type clash for variable ~w in ~@:\n\t\texpected type ~w in ~@\n\t\texpected type ~w in ~@\n', [I, format_rule(F), J, chr_translate:format_src(K), L, chr_translate:format_src(M)]))),
	    fail
	;   true
	).
...
constraints_code(A, C) :-
	(   chr_pp_flag(reduced_indexing, on),
	    forall(B, A, chr_translate:only_ground_indexed_arguments(B))
...
simple_guard_new(A, D) :-
	builtin_binds_b(A, B),
	not((member(C, B), memberchk_eq(C, D))).
...
simplification_code(B, B1, L, M, A, C, S, D, Q1, S1) :-
	...
	guard_via_reschedule_new(L, K, B, R, N, L1),
	rest_heads_retrieval_and_matching(L, M, B, N, Y, O, Q, [], [], [], P, _),
	guard_body_copies3(H, K, Q, R, O1),
	(   is_stored_in_guard(C, I)
	->  gen_occ_allocation_in_guard(C, S, U, T, W),
	...
	active_constraint_detachment(D, T, B, Q, N1),
	(   chr_pp_flag(debugable, on)
	->  H=rule(_, _, Z, A1),
...
head_arg_matches_([silent(B-_)|D], [A|E], F, C, H, I, J) :- !,
	...
	->  term_variables(B, G, C),
	    head_arg_matches_(D, E, F, G, H, I, J)
	;   head_arg_matches_(D, E, F, C, H, I, J)
	).
...
rest_heads_retrieval_and_matching_n([A|E1], [_|F1], F, B1, E, [C1|G1], [M|H1], G, I1, _, L, J1) :-
	...
	->  passive_head_via(A, [E|F], G, O, N),
	    ...
	    head_arg_matches(J, K, G, R, V, L, W),
	    T=J,
	...
	;   delay_phase_end(validate_store_type_assumptions, (static_suspension_term(C/B, H), get_static_suspension_term_field(arguments, C/B, H, I))),
	    existential_lookup(D, A, [E|F], G, L, H, S, M, J, T),
	    get_constraint_mode(C/B, K),
	    U=K,
	    head_arg_matches(T, U, G, R, V, L, W),
	    filter_append(T, V, X),
	    translate(W, X, Z),
	    translate(W, V, A1),
	...
	C1= (S, D1, Y),
	rest_heads_retrieval_and_matching_n(E1, F1, [A|F], [M|B1], E, G1, H1, V, I1, _, W, J1).
...
passive_head_via(A, D, P, I, H) :-
	...
	;   member(O, K),
	    ...
	    N==O
	->  translate([O], P, [Q]),
	    gen_get_mod_constraints(B/C, Q, R, H),
	    I=R
	;   translate(K, P, S),
	    add_heads_types(D, [], T),
	    my_term_copy(T, P, U),
	    gen_get_mod_constraints(B/C, S, U, V, R, H),
	    I= (V->R;J)
	).
...
guard_body_copies2(A, D, H, B1) :-
	...
	->  S=[],
	    T=[]
	;   bagof(Q-R, M^O^ (lists:member(M, N), pairlist:lookup_eq(D, M, O), memberchk_eq(O, P), chr_lock(O, Q), chr_unlock(O, R)), U)
	->  once(pairup(S, T, U))
	;   S=[],
	    T=[]
	),
...
simpagation_head2_code(H, C1, D, F, A, O, P, Q, R, E1) :-
	...
	extend_id(Q, V),
	(   memberchk_eq(S, T)
	->  simpagation_universal_searches(L, U, T, [K, H], B, O, P, Z, A1, B1, V, Y, W, X)
	;   W=X,
	    V=Y,
	    Z=L,
	    A1=[K, H],
	...
	universal_search_iterator_end(A1, Z, B, O, P, Y, X, D1),
...
simpagation_universal_searches(A, [I|L], J, C, D, E, F, N, O, P, B, R, G, T) :-
	A=[M|K],
	inc_id(B, Q),
	universal_search_iterator_end(C, A, D, E, F, B, G, H),
	universal_search_iterator(A, C, D, E, F, B, H, S),
	(   memberchk_eq(I, J)
	->  simpagation_universal_searches(K, L, J, [M|C], D, E, F, N, O, P, Q, R, S, T)
	;   R=Q,
	    S=T,
	    N=K,
	    O=[M|C],
...
simpagation_head2_worker([D|C], E, D1, _, A, V/W, X, Y, L2, N2) :-
	...
	guard_via_reschedule_new(E, C1, [D|C], N1, E1, H2),
	rest_heads_retrieval_and_matching(E, D1, [D|C], E1, G1, F1, K1, [D|C], [J|P], []),
	split_by_ids(D1, G1, H1, I1, W1),
	split_by_ids(D1, E, H1, J1, _),
	partner_constraint_detachments([J|I1], [D|J1], K1, I2),
	L1=[T|U],
...
propagation_single_headed(A, _, I, V, C/B, L, D, R1, T1) :-
	...
	->  use_auxiliary_predicate(novel_production),
	    ...
	    gen_occ_allocation(C/B, L, W, O, G1),
	    (   named_history(V, Y, X)
	    ->  (   X==[]
	    ...
	    (   is_observed(C/B, L)
	    ->  gen_uncond_attach_goal(C/B, O, W, E1, D1),
		gen_state_cond_call(O, C/B, C1, D1, F1)
	    ;   E1=true,
		F1=C1
	    )
	;   G1=true,
		...
		(   L==H1
		->  gen_insert_constraint_internal_goal(C/B, E1, E, W, O),
		    D1=0
		;   E1= (I1, J1),
		    gen_occ_allocation(C/B, L, W, O, I1),
		    gen_uncond_attach_goal(C/B, O, W, J1, D1)
		),
		gen_state_cond_call(O, C/B, C1, D1, F1)
	    ;   gen_occ_allocation(C/B, L, W, O, E1),
		F1=C1
	    )
	),
...
propagation_nested_code([], [A|B], H, C, I, D, E, F, G, K) :-
	universal_search_iterator_end([A|B], [], C, D, E, F, G, J),
	propagation_body(A, B, H, C, I, D, E, F, J, K).
propagation_nested_code([B|C], A, J, D, K, E, F, G, H, N) :-
	universal_search_iterator_end(A, [B|C], D, E, F, G, H, I),
	universal_search_iterator([B|C], A, D, E, F, G, I, M),
	inc_id(G, L),
	propagation_nested_code(C, [B|A], J, D, K, E, F, L, M, N).
...
propagation_body(C, B, O1, A, N1, P/Q, R, S, S2, U2) :-
	A=rule(_, Z1, D, E),
	gen_var_susp_list_for_b(B, [C, D, E], E1, F, U, G, V),
	flatten(F, O),
	init(G, F1),
	last(G, H1),
	gen_var(L),
	...
	->  universal_search_iterator_failure_vars(B, S, F, U, V, W, Y),
	    X=W
	;   X=[N|O],
	    Y=S
	),
	...
	(   is_observed(P/Q, R)
	->  init(U, I1),
	    gen_uncond_attach_goal(P/Q, H1, I1, L1, K1),
	    gen_state_cond_call(H1, P/Q, J1, K1, M1)
	;   L1=true,
	    M1=J1
	),
	...
	;   get_occurrence(P/Q, R, _, R1),
		...
		;   reverse([L|F1], U1),
		    named_history_susps(S1, [R1|O1], [H1|U1], V1),
		    V1=[W1|_],
		    (   length(S1, 1)
		    ->  Q1='$extend_history'(W1, T1),
			P1='$novel_production'(W1, T1)
		    ;   findall(X1, (member(Y1, S1), get_occurrence_from_id(X1, _, N1, Y1)), A2),
			B2=..[t, T1|V1]
		    )
		)
	    ;   W1=H1,
		...
		sort([R1|O1], S1),
		history_susps(O1, [L|F1], H1, R1, V1),
		B2=..[t, N1|V1]
	    ),
	    (   var(P1)
	    ->  novel_production_calls(A2, S1, V1, N1, C2, D2),
...
order_score(A, E, F, G, H, I) :-
	...
	order_score(D, A, E, F, G, H, 99999, I).
...
multi_order_score([A|I], B, C, D, E, F, G, J) :-
	(   order_score(A, B, C, D, E, F, G, H)
	->  true
	;   H=G
	),
	multi_order_score(I, B, C, D, E, F, H, J).
...
lookup_passive_head(multi_store(A), C, D, E, F, G, H) :-
	once((member(B, A), lookup_passive_head(B, C, D, E, F, G, H))).
...
hash_lookup_passive_head(I, A, B, C, K, N, J, D) :-
	...
	functor(B, G, H),
	multi_hash_lookup_goal(G/H, I, D, F, J, P),
	check_ground(K, L, M),
	my_term_copy(M, C, O),
	N= (O, P),
	(   I==inthash
...
existential_lookup(multi_store(A), C, D, E, F, G, H, I, J, K) :- !,
	once((member(B, A), existential_lookup(B, C, D, E, F, G, H, I, J, K))).
...
assume_constraint_stores([A|V]) :-
	...
	->  get_indexed_arguments(A, C),
	    get_constraint_mode(A, D),
	    aggregate_all(bag(B)-count, (member(B, C), nth1(B, D, +)), F-E),
	    (   E>10
	    ->  findall([B], member(B, F), H)
	    ;   findall(B, (sublist(B, F), B\==[]), G),
...
universal_search_iterator_end([C|B], D, A, L/M, N, G, W, Y) :-
	...
	universal_search_iterator_failure_vars(B, G, H, I, J, S, P),
	flatten(H, K),
	O=[[]|K],
	build_head(L, M, [N|G], O, T),
	(   P=[_]
	->  get_success_continuation_code_id(L/M, N, Q),
	    R=[Q]
	;   R=[N|P]
	),
...
universal_search_iterator([D|E], [C|B], A, A1/B1, C1, X, U1, W1) :-
	A=rule(_, _, F, G),
	gen_var_susp_list_for_b(B, [C, D, E, F, G], O, I, I1, H, J1),
	init(H, R),
	flatten(I, Z),
	gen_var(Y),
	functor(C, L, J),
	...
	lookup_passive_head(D, [C|B], V, W, Q1, E1),
	inc_id(X, G1),
	D1=[[Q|Y]|Z],
	build_head(A1, B1, [C1|X], D1, O1),
	passive_delegate_variables(C, B, [D, E, F, G], V, F1),
	append([E1|F1], [Q, Y|Z], H1),
	build_head(A1, B1, [C1|G1], H1, R1),
	(   check_fd_lookup_condition(L, J, C, B)
	->  universal_search_iterator_failure_vars(B, X, I, I1, J1, K1, M1),
	    L1=K1
	;   L1=[Y|Z],
	    M1=X
	),
...
collect_goal_constants(C, A) :-
	...
	->  ast_symbol(A, B),
		...
		ast_args(A, D),
		collect_constraint_constants(chr_constraint(B, D, E))
	    ;   B== (:)/2,
		ast_args(A, [F, I]),
		F=atomic(G),
		get_target_module(H),
		...
		ast_args(I, K),
		collect_constraint_constants(chr_constraint(J, K, L))
	    ;   true
	    )
	;   true
	).
...
collect_all_arg_constants([C|D], [A|E], H) :-
	...
	->  (   ast_ground(C)
		...
		collect_all_arg_constants(D, E, [F-G|H])
	    ;   true
	    )
...
flattening_dictionary_entry(A, F) :-
	...
	->  pairup(D, J, E),
	    ...
	    F=A-C-L-G,
	    get_chr_constants(I),
	    findall(K, (member(H, I), flat_spec(A, C, J, K)), L)
	;   M==yes
	->  enum_positions(B, 1, N, P, O),
	    F=A-N-L-O,
	    findall(K, (cartesian_product(Q, P), flat_spec(A, N, Q, K)), L)
	).
...
constant_positions([A|N], F, E, G, D, I) :-
	...
	O is F+1,
	constant_positions(N, O, K, L, M, J).
...
flat_spec(D/E, C, B, A) :-
	...
	term_to_atom(B, G),
	term_to_atom(C, F),
	atom_concat_list(['$flat_', D, /, E, '___', F, '___', G], H).
...
flatten_clauses(A, B, H) :-
	flatten_readcontent(A, C, E, F, _, G, D),
	flatten_clauses_(B, C, D, E, F, G, H).
...
declarations(B, C, D, E, H) :-
	findall(A, (member(A, B), \+memberchk(A-_-_-_, C)), F),
...
flatten_readcontent([A|H], B, C, D, F, E, G) :-
	...
	;   crude_is_rule(A)
	->  B=[A|I],
	    flatten_readcontent(H, I, C, D, F, E, G)
	;   pure_is_declaration(A, J, K, L)
	->  append(J, M, C),
	    append(K, N, D),
	    append(L, O, E),
	    flatten_readcontent(H, B, M, N, F, O, G)
	;   is_mode_declaration(A, P)
	->  D=[P|N],
	    flatten_readcontent(H, B, C, N, F, E, G)
	;   is_type_declaration(A, Q)
	->  E=[Q|O],
	    flatten_readcontent(H, B, C, D, F, O, G)
	;   is_type_definition(A, R)
	->  G=[A|T],
	    F=[R|S],
	    flatten_readcontent(H, B, C, D, S, E, T)
	;   (   A= (:-op(U, V, W))
	    ->  op(U, V, W)
	    ;   true
	    ),
	    G=[A|T],
	    flatten_readcontent(H, B, C, D, F, E, T)
	).
crude_is_rule(@(_, _)).
...
auxiliary_constraints_declarations(A, B, C, F) :-
	findall(D, auxiliary_constraints_declaration(A, B, C, D), E),
	flatten(E, F).
...
dispatching_rules([B-C-A-D|F], E) :-
	constraint_dispatching_rule(A, B, C, D, E, G),
...
constraint_dispatching_rule(N, C/D, A, O, B, Q) :-
	...
	P=swap(C, A),
	dispatching_rule_term_cases(N, A, M, O, P, L, Q).
...
dispatching_rule_term_cases(B, A, M/D, J, K, N, O) :-
	...
	dispatch_trie_index(G, H, I, J, K, L, M, N, O).
dispatching_action(B, C, A) :-
	A=..[B|C].
dispatch_trie_index(A, C, D, E, F, G, B, H, I) :-
	dispatch_trie_step(A, B, B, C, D, E, F, G, H, I).
...
dispatch_trie_step(C, N, O, A, J, K, L, M, P, Q) :-
	...
	aggregate_all(set(E/F), (member(D, C), functor(D, E, F)), H),
	I is G+1,
	dispatch_trie_step_cases(H, I, C, A, J, K, L, M, N, O, P, Q).
...
dispatch_trie_step_cases([A|L], B, C, D, E, F, G, H, I, J, K, N) :-
	dispatch_trie_step_case(A, B, C, D, E, F, G, H, I, J, K, M),
	dispatch_trie_step_cases(L, B, C, D, E, F, G, H, I, J, M, N).
dispatch_trie_step_case(L/M, D, S, X, E, B, N, T, G, I1, [A|Q], R) :-
	...
	(   P==I
	->  Q=R,
	    rec_cases(S, _, T, L/M, _, _, U),
	    U=[V],
	    call(V, I, W)
	;   rec_cases(S, X, T, L/M, Z, Y, U),
	    (   U=[B1]
	    ->  Y=[A1],
		append([Z, A1, I], P),
		Q=R,
		...
		append(J1, I, L1),
		W=..[K1|L1],
		findall(M1-N1, member([M1|N1], O1), P1),
		once(pairup(Q1, R1, P1)),
		dispatch_trie_step(Q1, K1, I1, R1, E, B, S1, U, Q, R)
	    )
	).
split([D|F], A, B, C, E) :-
	(   A==1
...
term_to_ast_term(A, B, D, C) :-
	...
	->  functor(A, E, F),
	    B=compound(E, F, H, A),
	    A=..[_|G],
	    maplist_dcg(chr_translate:term_to_ast_term, G, H, D, C)
	;   var(A)
...
chr_constraint_to_ast_constraint(B, A, G, H) :-
	...
	functor(B, C, D),
	B=..[_|E],
	maplist_dcg(chr_translate:term_to_ast_term, E, F, G, H).
rule_to_ast_rule(B, A) :-
	...
	(   E==[]
	->  F=propagation(H),
	    maplist_dcg(chr_translate:chr_constraint_to_ast_constraint, G, H, I, J)
	;   G==[]
	->  F=simplification(H),
	    maplist_dcg(chr_translate:chr_constraint_to_ast_constraint, E, H, I, J)
	;   F=simpagation(K, L),
	    maplist_dcg(chr_translate:chr_constraint_to_ast_constraint, E, K, I, M),
	    maplist_dcg(chr_translate:chr_constraint_to_ast_constraint, G, L, M, J)
	),
	conj2list(C, N),
	maplist_dcg(chr_translate:term_to_ast_term, N, O, J, R),
	conj2list(D, P),
	maplist_dcg(chr_translate:term_to_ast_term, P, Q, R, _).
...
ast_head_arg_matches_([silent(B-_)|D], [A|E], F, C, H, I, J) :- !,
	...
	->  ast_term_variables(B, G, C),
	    ast_head_arg_matches_(D, E, F, G, H, I, J)
	;   ast_head_arg_matches_(D, E, F, C, H, I, J)
	).
ast_head_arg_matches_([A-G|L], [D|M], C, E, F, B1, C1) :-
	...
	ast_head_arg_matches_(Q, R, K, J, I, B1, C1).
...
attach_generate_empty_named_history_initialisation___1([A|Q], D) :-
	...
	attach_generate_empty_named_history_initialisation___1(Q, D).
...
detach_generate_empty_named_history_initialisation___1([A|Q], E) :-
	...
	->  B=v(C, D, H, I, J, K, L, M, N, O, P),
		...
		->  G is C/\ -2,
		    ...
		    ;   put_attr(A, chr_translate, v(G, [], H, I, J, K, L, M, N, O, P))
		    )
		;   put_attr(A, chr_translate, v(C, F, H, I, J, K, L, M, N, O, P))
		)
	    ;   true
	    )
	;   true
	),
	detach_generate_empty_named_history_initialisation___1(Q, E).
...
detach_symbol_count___2([A|Q], E) :-
	...
	->  B=v(C, H, D, I, J, K, L, M, N, O, P),
		...
		;   put_attr(A, chr_translate, v(C, H, F, I, J, K, L, M, N, O, P))
		)
	    ;   true
	    )
	;   true
...
detach_fresh_symbol___2([A|Q], E) :-
	...
	->  B=v(C, H, I, D, J, K, L, M, N, O, P),
		...
		;   put_attr(A, chr_translate, v(C, H, I, F, J, K, L, M, N, O, P))
		)
	    ;   true
	    )
	;   true
...
detach_background_info___2([A|Q], E) :-
	...
	->  B=v(C, H, I, J, D, K, L, M, N, O, P),
		...
		;   put_attr(A, chr_translate, v(C, H, I, J, F, K, L, M, N, O, P))
		)
	    ;   true
	    )
	;   true
...
detach_get_bg_info___2([A|Q], E) :-
	...
	->  B=v(C, H, I, J, K, D, L, M, N, O, P),
		...
		;   put_attr(A, chr_translate, v(C, H, I, J, K, F, L, M, N, O, P))
		)
	    ;   true
	    )
	;   true
...
detach_type_definition___2([A|Q], E) :-
	...
	->  B=v(C, H, I, J, K, L, D, M, N, O, P),
		...
		;   put_attr(A, chr_translate, v(C, H, I, J, K, L, F, M, N, O, P))
		)
	    ;   true
	    )
	;   true
...
detach_type_alias___2([A|Q], E) :-
	...
	->  B=v(C, H, I, J, K, L, M, D, N, O, P),
		...
		;   put_attr(A, chr_translate, v(C, H, I, J, K, L, M, F, N, O, P))
		)
	    ;   true
	    )
	;   true
...
attach_unalias_type___2([A|Q], K) :-
	...
	->  (   B=v(C, D, E, F, G, H, I, J, L, M, N),
	    ...
	    put_attr(A, chr_translate, O)
	;   put_attr(A, chr_translate, v(128, [], [], [], [], [], [], [], [K], [], []))
	),
...
detach_unalias_type___2([A|Q], E) :-
	...
	->  B=v(C, H, I, J, K, L, M, N, D, O, P),
		...
		;   put_attr(A, chr_translate, v(C, H, I, J, K, L, M, N, F, O, P))
		)
	    ;   true
	    )
	;   true
...
attach_ast_static_type_check_var___4([A|Q], L) :-
	...
	->  (   B=v(C, D, E, F, G, H, I, J, K, M, N),
	    ...
	    put_attr(A, chr_translate, O)
	;   put_attr(A, chr_translate, v(256, [], [], [], [], [], [], [], [], [L], []))
	),
...
detach_ast_static_type_check_var___4([A|Q], E) :-
	...
	->  B=v(C, H, I, J, K, L, M, N, O, D, P),
		...
		;   put_attr(A, chr_translate, v(C, H, I, J, K, L, M, N, O, F, P))
		)
	    ;   true
	    )
	;   true
...
attach_atomic_type___1([A|Q], M) :-
	...
	->  (   B=v(C, D, E, F, G, H, I, J, K, L, N),
	    ...
	    put_attr(A, chr_translate, O)
	;   put_attr(A, chr_translate, v(512, [], [], [], [], [], [], [], [], [], [M]))
	),
...
detach_atomic_type___1([A|Q], E) :-
	...
	->  B=v(C, H, I, J, K, L, M, N, O, P, D),
		...
		;   put_attr(A, chr_translate, v(C, H, I, J, K, L, M, N, O, P, F))
		)
	    ;   true
	    )
	;   true
...
attach_increment([A|U1], B) :-
	...
	->  (   B=v(H1, E, H, K, N, Q, T, W, Z, C1, F1),
	    ...
	    put_attr(A, chr_translate, v(J1, K1, L1, M1, N1, O1, P1, Q1, R1, S1, T1))
...
attr_unify_hook(v(Q1, A, B, C, D, E, F, G, H, I, J), K) :-
	...
	->  (   get_attr(K, chr_translate, L)
		...
		put_attr(K, chr_translate, v(S1, T1, U1, V1, W1, X1, Y1, Z1, A2, B2, C2)),
	    ...
	    ;   put_attr(K, chr_translate, v(Q1, N, Q, T, W, Z, C1, F1, I1, L1, O1)),
		'$run_suspensions_generate_empty_named_history_initialisation___1'(N),
		'$run_suspensions_symbol_count___2'(Q),
		'$run_suspensions_fresh_symbol___2'(T),
	...
	;   (   compound(K)
	    ->  term_variables(K, D2),
		attach_increment(D2, v(Q1, N, Q, T, W, Z, C1, F1, I1, L1, O1))
	    ;   true
	    ),
	    '$run_suspensions_generate_empty_named_history_initialisation___1'(N),
	    '$run_suspensions_symbol_count___2'(Q),
...
'$run_suspensions_ast_static_type_check_var___4'([A|G]) :-
	...
	(   B==active
	->  setarg(2, A, triggered),
	    ast_static_type_check_var___4__0(C, D, E, F, A),
	    (   B==triggered
	    ->  setarg(2, A, active)
	    ;   true
	    )
...
'$enumerate_constraints'(validate_store_type_assumption, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____validate_store_type_assumption___1-1', A),
	value_ht(A, B),
	B=suspension(_, _, D),
...
'$enumerate_constraints'(least_occurrence, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____least_occurrence___2-12', A),
	value_ht(A, B),
	B=suspension(_, _, D, E),
...
'$enumerate_constraints'(observation_analysis, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____observation_analysis___1', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D),
...
'$enumerate_constraints'(spawns_all_triggers, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____spawns_all_triggers___2', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, _, D, E),
...
'$enumerate_constraints'(generate_empty_named_history_initialisation, C) :-
	nb_getval('$chr_store_global_list_chr_translate____generate_empty_named_history_initialisation___1', A),
	'chr sbag_member'(B, A),
...
'$enumerate_constraints'(actual_atomic_multi_hash_keys, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____actual_atomic_multi_hash_keys___3-12', A),
	value_ht(A, B),
	B=suspension(_, _, D, E, F),
	C=actual_atomic_multi_hash_keys(D, E, F).
'$enumerate_constraints'(actual_ground_multi_hash_keys, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____actual_ground_multi_hash_keys___3-12', A),
	value_ht(A, B),
	B=suspension(_, _, D, E, F),
	C=actual_ground_multi_hash_keys(D, E, F).
'$enumerate_constraints'(actual_non_ground_multi_hash_key, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____actual_non_ground_multi_hash_key___2-12', A),
	value_ht(A, B),
	B=suspension(_, _, D, E),
	C=actual_non_ground_multi_hash_key(D, E).
'$enumerate_constraints'(symbol_count, C) :-
	nb_getval('$chr_store_global_list_chr_translate____symbol_count___2', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D, E),
	C=symbol_count(D, E).
'$enumerate_constraints'(fresh_symbol, C) :-
	nb_getval('$chr_store_global_list_chr_translate____fresh_symbol___2', A),
	'chr sbag_member'(B, A),
...
'$enumerate_constraints'(background_info, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____background_info___1', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D),
	C=background_info(D).
'$enumerate_constraints'(background_info, C) :-
	nb_getval('$chr_store_global_list_chr_translate____background_info___2', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, _, _, D, E),
	C=background_info(D, E).
'$enumerate_constraints'(get_bg_info, C) :-
	nb_getval('$chr_store_global_list_chr_translate____get_bg_info___2', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, _, _, D, E),
	C=get_bg_info(D, E).
'$enumerate_constraints'(get_bg_info_answer, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____get_bg_info_answer___1', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D),
...
'$enumerate_constraints'(type_definition, C) :-
	nb_getval('$chr_store_global_list_chr_translate____type_definition___2', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, _, _, D, E),
	C=type_definition(D, E).
'$enumerate_constraints'(type_alias, C) :-
	nb_getval('$chr_store_global_list_chr_translate____type_alias___2', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, _, _, D, E),
	C=type_alias(D, E).
'$enumerate_constraints'(constraint_type, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____constraint_type___2', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D, E),
	C=constraint_type(D, E).
'$enumerate_constraints'(unalias_type, C) :-
	nb_getval('$chr_store_global_list_chr_translate____unalias_type___2', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D, E),
	C=unalias_type(D, E).
'$enumerate_constraints'(types_modes_condition, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____types_modes_condition___3', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D, E, F),
	C=types_modes_condition(D, E, F).
'$enumerate_constraints'(static_type_check, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____static_type_check___2', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D, E),
	C=static_type_check(D, E).
'$enumerate_constraints'(ast_static_type_check_var, C) :-
	nb_getval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', A),
	'chr sbag_member'(B, A),
...
'$enumerate_constraints'(ast_static_atomic_builtin_type_check_var, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-1', A),
	value_ht(A, B),
	B=suspension(_, _, D, E, F, G),
...
'$enumerate_constraints'(atomic_type, C) :-
	nb_getval('$chr_store_global_list_chr_translate____atomic_type___1', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D),
	C=atomic_type(D).
'$enumerate_constraints'(stored, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____stored___3-13', A),
	value_ht(A, B),
	B=suspension(_, _, D, E, F),
	C=stored(D, E, F).
'$enumerate_constraints'(stored_complete, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-13', A),
	value_ht(A, B),
	B=suspension(_, _, _, D, E, F),
	C=stored_complete(D, E, F).
'$enumerate_constraints'(check_all_passive, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____check_all_passive___2-12', A),
	value_ht(A, B),
	B=suspension(_, _, D, E),
	C=check_all_passive(D, E).
'$enumerate_constraints'(constraints_code1, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____constraints_code1___3', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D, E, F),
	C=constraints_code1(D, E, F).
'$enumerate_constraints'(memo_has_active_occurrence, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____memo_has_active_occurrence___1-1', A),
	value_ht(A, B),
	B=suspension(_, _, D),
...
'$enumerate_constraints'(ai_not_observed_internal, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____ai_not_observed_internal___2', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D, E),
...
'$enumerate_constraints'(ai_observation_memo_abstract_goal, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____ai_observation_memo_abstract_goal___2', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D, E),
	C=ai_observation_memo_abstract_goal(D, E).
'$enumerate_constraints'(partial_wake_analysis, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____partial_wake_analysis___0', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, _),
...
'$enumerate_constraints'(stored_assertion, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____stored_assertion___1-1', A),
	value_ht(A, B),
	B=suspension(_, _, D),
	C=stored_assertion(D).
'$enumerate_constraints'(never_stored_default, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____never_stored_default___2-1', A),
	value_ht(A, B),
	B=suspension(_, _, D, E),
	C=never_stored_default(D, E).
'$enumerate_constraints'(never_stored_rules, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____never_stored_rules___2', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D, E),
	C=never_stored_rules(D, E).
'$enumerate_constraints'(continuation_occurrence, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____continuation_occurrence___3-12', A),
	value_ht(A, B),
	B=suspension(_, _, D, E, F),
	C=continuation_occurrence(D, E, F).
'$enumerate_constraints'(skip_to_next_id, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____skip_to_next_id___2-12', A),
	value_ht(A, B),
	B=suspension(_, _, _, D, E),
	C=skip_to_next_id(D, E).
'$enumerate_constraints'(set_occurrence_code_id, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____set_occurrence_code_id___3-12', A),
	value_ht(A, B),
	B=suspension(_, _, D, E, F),
	C=set_occurrence_code_id(D, E, F).
'$enumerate_constraints'(occurrence_code_id, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____occurrence_code_id___3-12', A),
	value_ht(A, B),
	B=suspension(_, _, D, E, F),
	C=occurrence_code_id(D, E, F).
'$enumerate_constraints'(chr_constants, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____chr_constants___1', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _, D),
	C=chr_constants(D).
'$enumerate_constraints'(print_chr_constants, C) :-
	nb_getval('$chr_store_global_ground_chr_translate____print_chr_constants___0', A),
	'chr sbag_member'(B, A),
	B=suspension(_, _, _),
...
'$via1_multi_hash_occurrence___5-15'(B, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-15', A),
	lookup_ht(A, B, C).
'$via1_multi_hash_occurrence___5-125'(B, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-125', A),
	lookup_ht(A, B, C).
...
'$via1_multi_hash_actual_atomic_multi_hash_keys___3-1'(B, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____actual_atomic_multi_hash_keys___3-1', A),
	lookup_ht(A, B, C).
'$via1_multi_hash_actual_ground_multi_hash_keys___3-12'(B, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____actual_ground_multi_hash_keys___3-12', A),
	lookup_ht(A, B, C).
'$via1_multi_hash_actual_ground_multi_hash_keys___3-1'(B, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____actual_ground_multi_hash_keys___3-1', A),
	lookup_ht(A, B, C).
...
'$via1_multi_hash_stored___3-123'(B, C) :-
	nb_getval('$chr_store_multi_hash_chr_translate____stored___3-123', A),
	lookup_ht(A, B, C).
...
'$chr_initialization' :-
	...
	new_ht(A),
	nb_setval('$chr_store_multi_hash_chr_translate____occurrence_code_id___3-12', A),
	new_ht(B),
	nb_setval('$chr_store_multi_hash_chr_translate____set_occurrence_code_id___3-12', B),
	new_ht(C),
	nb_setval('$chr_store_multi_hash_chr_translate____skip_to_next_id___2-12', C),
	new_ht(D),
	nb_setval('$chr_store_multi_hash_chr_translate____continuation_occurrence___3-12', D),
	nb_setval('$chr_store_global_ground_chr_translate____never_stored_rules___2', []),
	new_ht(E),
	nb_setval('$chr_store_multi_hash_chr_translate____never_stored_default___2-1', E),
	new_ht(F),
	nb_setval('$chr_store_multi_hash_chr_translate____stored_assertion___1-1', F),
	nb_setval('$chr_store_global_ground_chr_translate____used_states_known___0', []),
	new_ht(G),
	nb_setval('$chr_store_multi_hash_chr_translate____if_used_state___5-12', G),
	nb_setval('$chr_store_global_ground_chr_translate____if_used_state___5', []),
	new_ht(H),
	nb_setval('$chr_store_multi_hash_chr_translate____uses_state___2-12', H),
	new_ht(I),
	nb_setval('$chr_store_multi_hash_chr_translate____does_use_field___2-12', I),
	new_ht(J),
	nb_setval('$chr_store_multi_hash_chr_translate____does_use_history___2-12', J),
	new_ht(K),
	nb_setval('$chr_store_multi_hash_chr_translate____does_use_history___2-1', K),
	new_ht(L),
	nb_setval('$chr_store_multi_hash_chr_translate____delay_phase_end___2-1', L),
	new_ht(M),
	nb_setval('$chr_store_multi_hash_chr_translate____phase_end___1-1', M),
	new_ht(N),
	nb_setval('$chr_store_multi_hash_chr_translate____no_partial_wake___1-1', N),
	...
	new_ht(O),
	nb_setval('$chr_store_multi_hash_chr_translate____ai_observation_memoed_abstract_goal___2-1', O),
	new_ht(P),
	nb_setval('$chr_store_multi_hash_chr_translate____ai_observation_memoed_propagation_rest_heads___3-12', P),
	new_ht(Q),
	nb_setval('$chr_store_multi_hash_chr_translate____ai_observation_memoed_simplification_rest_heads___3-12', Q),
	nb_setval('$chr_store_global_ground_chr_translate____ai_observation_gather_results___0', []),
	new_ht(R),
	nb_setval('$chr_store_multi_hash_chr_translate____depends_on_as___3-2', R),
	new_ht(S),
	nb_setval('$chr_store_multi_hash_chr_translate____depends_on_as___3-3', S),
	new_ht(T),
	nb_setval('$chr_store_multi_hash_chr_translate____ai_not_observed___2-12', T),
	new_ht(U),
	nb_setval('$chr_store_multi_hash_chr_translate____ai_not_observed_internal___2-12', U),
	nb_setval('$chr_store_global_ground_chr_translate____ai_not_observed_internal___2', []),
	new_ht(V),
	nb_setval('$chr_store_multi_hash_chr_translate____ai_observed_internal___2-12', V),
	nb_setval('$chr_store_global_ground_chr_translate____ai_observed_internal___2', []),
	new_ht(W),
	nb_setval('$chr_store_multi_hash_chr_translate____depends_on_goal___2-2', W),
	new_ht(X),
	nb_setval('$chr_store_multi_hash_chr_translate____depends_on_ap___4-3', X),
	new_ht(Y),
	nb_setval('$chr_store_multi_hash_chr_translate____depends_on_ap___4-2', Y),
	new_ht(Z),
	nb_setval('$chr_store_multi_hash_chr_translate____depends_on___2-2', Z),
	new_ht(A1),
	nb_setval('$chr_store_multi_hash_chr_translate____depends_on___2-1', A1),
	nb_setval('$chr_store_global_ground_chr_translate____abstract_constraints___1', []),
	new_ht(B1),
	nb_setval('$chr_store_multi_hash_chr_translate____final_answer_pattern___2-1', B1),
	new_ht(C1),
	nb_setval('$chr_store_multi_hash_chr_translate____call_pattern___1-1', C1),
	new_ht(D1),
	nb_setval('$chr_store_multi_hash_chr_translate____initial_call_pattern___1-1', D1),
	new_ht(E1),
	nb_setval('$chr_store_multi_hash_chr_translate____functional_dependency___4-12', E1),
	new_ht(F1),
	nb_setval('$chr_store_multi_hash_chr_translate____functional_dependency___4-1', F1),
	new_ht(G1),
	nb_setval('$chr_store_multi_hash_chr_translate____use_auxiliary_module___1-1', G1),
	new_ht(H1),
	nb_setval('$chr_store_multi_hash_chr_translate____use_auxiliary_predicate___2-12', H1),
	new_ht(I1),
	nb_setval('$chr_store_multi_hash_chr_translate____use_auxiliary_predicate___2-1', I1),
	new_ht(J1),
	nb_setval('$chr_store_multi_hash_chr_translate____use_auxiliary_predicate___1-1', J1),
	new_ht(K1),
	nb_setval('$chr_store_multi_hash_chr_translate____memo_has_active_occurrence___1-1', K1),
	nb_setval('$chr_store_global_ground_chr_translate____constraints_code1___3', []),
	new_ht(L1),
	nb_setval('$chr_store_multi_hash_chr_translate____check_all_passive___2-1', L1),
	new_ht(M1),
	nb_setval('$chr_store_multi_hash_chr_translate____check_all_passive___2-12', M1),
	new_ht(N1),
	nb_setval('$chr_store_multi_hash_chr_translate____stored_complete___3-1', N1),
	new_ht(O1),
	nb_setval('$chr_store_multi_hash_chr_translate____stored_complete___3-13', O1),
	new_ht(P1),
	...
	new_ht(R1),
	nb_setval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-13', R1),
	new_ht(S1),
	nb_setval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-1', S1),
	...
	new_ht(T1),
	nb_setval('$chr_store_multi_hash_chr_translate____constraint_type___2-1', T1),
	...
	new_ht(V1),
	nb_setval('$chr_store_multi_hash_chr_translate____set_all_passive___1-1', V1),
	new_ht(W1),
	nb_setval('$chr_store_multi_hash_chr_translate____prev_guard_list___6-1', W1),
	...
	new_ht(X1),
	nb_setval('$chr_store_multi_hash_chr_translate____prolog_global_variable___1-1', X1),
	...
	new_ht(Y1),
	nb_setval('$chr_store_multi_hash_chr_translate____actual_non_ground_multi_hash_key___2-12', Y1),
	new_ht(Z1),
	nb_setval('$chr_store_multi_hash_chr_translate____actual_ground_multi_hash_keys___3-1', Z1),
	new_ht(A2),
	nb_setval('$chr_store_multi_hash_chr_translate____actual_ground_multi_hash_keys___3-12', A2),
	new_ht(B2),
	nb_setval('$chr_store_multi_hash_chr_translate____actual_atomic_multi_hash_keys___3-1', B2),
	new_ht(C2),
	nb_setval('$chr_store_multi_hash_chr_translate____actual_atomic_multi_hash_keys___3-12', C2),
	...
	new_ht(D2),
	nb_setval('$chr_store_multi_hash_chr_translate____spawns_all_triggers___2-12', D2),
	new_ht(E2),
	nb_setval('$chr_store_multi_hash_chr_translate____spawns_all_triggers___2-1', E2),
	nb_setval('$chr_store_global_ground_chr_translate____spawns_all_triggers___2', []),
	new_ht(F2),
	nb_setval('$chr_store_multi_hash_chr_translate____spawns_all___2-12', F2),
	new_ht(G2),
	nb_setval('$chr_store_multi_hash_chr_translate____spawns_all___2-1', G2),
	new_ht(H2),
	...
	new_ht(M2),
	nb_setval('$chr_store_multi_hash_chr_translate____indexing_spec___2-1', M2),
	new_ht(N2),
	...
	new_ht(P2),
	nb_setval('$chr_store_multi_hash_chr_translate____no_history___1-1', P2),
	new_ht(Q2),
	nb_setval('$chr_store_multi_hash_chr_translate____type_indexed_identifier_index___4-23', Q2),
	new_ht(R2),
	nb_setval('$chr_store_multi_hash_chr_translate____type_indexed_identifier_index___4-123', R2),
	new_ht(S2),
	nb_setval('$chr_store_multi_hash_chr_translate____type_indexed_identifier_size___2-1', S2),
	new_ht(T2),
	nb_setval('$chr_store_multi_hash_chr_translate____identifier_index___3-12', T2),
	...
	new_ht(U2),
	nb_setval('$chr_store_multi_hash_chr_translate____constraint_index___2-1', U2),
	new_ht(V2),
	nb_setval('$chr_store_multi_hash_chr_translate____constraint_index___2-2', V2),
	new_ht(W2),
	nb_setval('$chr_store_multi_hash_chr_translate____least_occurrence___2-1', W2),
	new_ht(X2),
	nb_setval('$chr_store_multi_hash_chr_translate____least_occurrence___2-12', X2),
	new_ht(Y2),
	nb_setval('$chr_store_multi_hash_chr_translate____rule___2-1', Y2),
	nb_setval('$chr_store_global_ground_chr_translate____rule___2', []),
	new_ht(Z2),
	nb_setval('$chr_store_multi_hash_chr_translate____allocation_occurrence___2-12', Z2),
	new_ht(A3),
	nb_setval('$chr_store_multi_hash_chr_translate____allocation_occurrence___2-1', A3),
	new_ht(B3),
	nb_setval('$chr_store_multi_hash_chr_translate____max_occurrence___2-1', B3),
	new_ht(C3),
	nb_setval('$chr_store_multi_hash_chr_translate____occurrence___5-1', C3),
	new_ht(D3),
	nb_setval('$chr_store_multi_hash_chr_translate____occurrence___5-34', D3),
	new_ht(E3),
	nb_setval('$chr_store_multi_hash_chr_translate____occurrence___5-13', E3),
	new_ht(F3),
	nb_setval('$chr_store_multi_hash_chr_translate____occurrence___5-3', F3),
	new_ht(G3),
	nb_setval('$chr_store_multi_hash_chr_translate____occurrence___5-12', G3),
	new_ht(H3),
	nb_setval('$chr_store_multi_hash_chr_translate____occurrence___5-134', H3),
	new_ht(I3),
	nb_setval('$chr_store_multi_hash_chr_translate____occurrence___5-125', I3),
	nb_setval('$chr_store_global_ground_chr_translate____occurrence___5', []),
	new_ht(J3),
	nb_setval('$chr_store_multi_hash_chr_translate____occurrence___5-15', J3),
	new_ht(K3),
	...
	new_ht(M3),
	nb_setval('$chr_store_multi_hash_chr_translate____validate_store_type_assumption___1-1', M3),
	new_ht(N3),
	nb_setval('$chr_store_multi_hash_chr_translate____assumed_store_type___2-1', N3),
	new_ht(O3),
	nb_setval('$chr_store_multi_hash_chr_translate____actual_store_types___2-1', O3),
	new_ht(P3),
	nb_setval('$chr_store_multi_hash_chr_translate____store_type___2-1', P3),
	nb_setval('$chr_store_global_ground_chr_translate____none_suspended_on_variables___0', []),
	new_ht(Q3),
	nb_setval('$chr_store_multi_hash_chr_translate____constraint_mode___2-1', Q3),
	nb_setval('$chr_store_global_ground_chr_translate____constraint_mode___2', []),
	new_ht(R3),
	nb_setval('$chr_store_multi_hash_chr_translate____indexed_argument___2-12', R3),
	new_ht(S3),
	nb_setval('$chr_store_multi_hash_chr_translate____indexed_argument___2-1', S3),
	new_ht(T3),
	nb_setval('$chr_store_multi_hash_chr_translate____line_number___2-1', T3),
...
constraint_mode___2__1(A, C, B) :-
	...
	'chr gen_id'(D),
	constraint_mode___2__1__0__7(E, A, C, B, F, G).
...
constraint_mode___2__1__0__7([A|C1], Q, S, K, E, F) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    ->  setarg(2, K, inactive),
		constraint_mode___2__1__0__7(C1, Q, S, K, E, F)
	    ;   true
	    )
	;   constraint_mode___2__1__0__7(C1, Q, S, K, E, F)
	).
...
constraint_mode___2__2__0__8([A|H], C, I, J) :-
	...
	->  constraint_mode___2__2__1__8(D, E, F, G, A, H, C, I, J)
...
constraint_mode___2__2__1__8([A|E], C, F, G, H, I, J, K, L) :-
	(   A=suspension(_, active, _, _),
	    ...
	    lookup_ht(B, C, D)
	->  constraint_mode___2__2__2__8(D, A, E, C, F, G, H, I, J, K, L)
	;   constraint_mode___2__2__1__8(E, C, F, G, H, I, J, K, L)
	).
constraint_mode___2__2__2__8([], _, A, B, C, D, E, F, G, H, I) :-
	constraint_mode___2__2__1__8(A, B, C, D, E, F, G, H, I).
constraint_mode___2__2__2__8([A|X], D, Y, C, O, P, E, Z, M, U, F) :-
	...
	->  '$extend_history'(F, G),
	    ...
	    ->  setarg(2, F, inactive),
		constraint_mode___2__2__2__8(X, D, Y, C, O, P, E, Z, M, U, F)
	    ;   true
	    )
	;   constraint_mode___2__2__2__8(X, D, Y, C, O, P, E, Z, M, U, F)
	).
...
store_type___2__1(B, _, J) :-
	...
	delete_ht(H, B, D),
	setarg(2, G, removed),
	nb_getval('$chr_store_multi_hash_chr_translate____actual_store_types___2-1', I),
	delete_ht(I, B, G),
	(   var(J)
	->  true
	;   arg(2, J, K),
	    ...
	    (   K==not_stored_yet
	    ->  true
	    ;   nb_getval('$chr_store_multi_hash_chr_translate____store_type___2-1', L),
		delete_ht(L, B, J)
	    )
	),
...
actual_store_types(B, K) :-
	...
	setarg(2, D, removed),
	nb_getval('$chr_store_multi_hash_chr_translate____actual_atomic_multi_hash_keys___3-12', H),
	delete_ht(H, k(B, I), D),
	nb_getval('$chr_store_multi_hash_chr_translate____actual_atomic_multi_hash_keys___3-1', J),
	delete_ht(J, B, D),
	delete(K, multi_hash([I]), R),
	I=[L],
	...
	actual_store_types(B, [atomic_constants(I, O, Q)|R]).
actual_store_types(B, P) :-
	...
	G=suspension(_, active, _), !,
	setarg(2, D, removed),
	nb_getval('$chr_store_multi_hash_chr_translate____actual_ground_multi_hash_keys___3-12', H),
	delete_ht(H, k(B, I), D),
	...
	delete(P, multi_hash([I]), Q),
	actual_store_types(B, [ground_constants(I, M, O)|Q]).
actual_store_types(B, E) :-
	...
	(   (   memberchk(multi_hash([[F]]), E),
		(   get_constraint_type(B, G),
		    ...
		    delete(E, multi_hash([[F]]), J),
		    actual_store_types(B, [atomic_constants([F], I, complete)|J])
		;   get_constraint_arg_type(B, F, K),
		    K=chr_enum(L), !,
		    delete(E, multi_hash([[F]]), M),
		    actual_store_types(B, [ground_constants([F], L, complete)|M])
		)
	    ;   nb_getval('$chr_store_multi_hash_chr_translate____assumed_store_type___2-1', N),
		lookup_ht(N, B, O),
		'chr sbag_member'(P, O),
		...
		delete_ht(Q, B, D),
		setarg(2, P, removed),
		nb_getval('$chr_store_multi_hash_chr_translate____assumed_store_type___2-1', R),
		delete_ht(R, B, P),
	...
	;   nb_getval('$chr_store_multi_hash_chr_translate____store_type___2-1', T),
	    lookup_ht(T, B, U),
	    'chr sbag_member'(V, U),
	    V=suspension(_, active, _, _), !,
	    setarg(2, D, removed),
	    nb_getval('$chr_store_multi_hash_chr_translate____validate_store_type_assumption___1-1', W),
	    delete_ht(W, B, D),
	    setarg(2, V, removed),
	    nb_getval('$chr_store_multi_hash_chr_translate____store_type___2-1', X),
	    delete_ht(X, B, V),
...
validate_store_type_assumption___1__0__0__1([A|V], C, K) :-
	(   (   A=suspension(_, active, B, N),
	    ...
	    (   ground(C),
	    nb_getval('$chr_store_multi_hash_chr_translate____actual_atomic_multi_hash_keys___3-1', D),
	    lookup_ht(D, C, E)
	    ),
	    'chr sbag_member'(F, E),
	...
	->  (   (   setarg(2, A, removed),
	    ...
	    actual_store_types(C, [atomic_constants(I, R, T)|U])
	    ),
	    (   K=suspension(_, active, _)
	    ->  setarg(2, K, inactive),
		validate_store_type_assumption___1__0__0__1(V, C, K)
	    ;   true
	    )
	;   validate_store_type_assumption___1__0__0__1(V, C, K)
	).
...
validate_store_type_assumption___1__1__0__2([A|U], C, K) :-
	(   (   A=suspension(_, active, B, S),
	    ...
	    (   ground(C),
	    nb_getval('$chr_store_multi_hash_chr_translate____actual_ground_multi_hash_keys___3-1', D),
	    lookup_ht(D, C, E)
	    ),
	    'chr sbag_member'(F, E),
	...
	->  (   (   setarg(2, A, removed),
	    ...
	    delete(S, multi_hash([I]), T),
	    actual_store_types(C, [ground_constants(I, P, R)|T])
	    ),
	    (   K=suspension(_, active, _)
	    ->  setarg(2, K, inactive),
		validate_store_type_assumption___1__1__0__2(U, C, K)
	    ;   true
	    )
	;   validate_store_type_assumption___1__1__0__2(U, C, K)
	).
...
validate_store_type_assumption___1__2__0__3([A|N], C, I) :-
	...
	->  (   setarg(2, A, removed),
	    nb_getval('$chr_store_multi_hash_chr_translate____actual_store_types___2-1', H),
	    delete_ht(H, C, A)
	    ),
	    (   arg(2, I, J),
	    setarg(2, I, active),
	    ...
	    (   delete(D, multi_hash([[E]]), M),
	    actual_store_types(C, [atomic_constants([E], L, complete)|M])
	    ),
	    (   I=suspension(_, active, _)
	    ->  setarg(2, I, inactive),
		validate_store_type_assumption___1__2__0__3(N, C, I)
	    ;   true
	    )
	;   validate_store_type_assumption___1__2__0__3(N, C, I)
	).
...
validate_store_type_assumption___1__3__0__4([A|M], C, H) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    (   delete(D, multi_hash([[E]]), L),
	    actual_store_types(C, [ground_constants([E], K, complete)|L])
	    ),
	    (   H=suspension(_, active, _)
	    ->  setarg(2, H, inactive),
		validate_store_type_assumption___1__3__0__4(M, C, H)
	    ;   true
	    )
	;   validate_store_type_assumption___1__3__0__4(M, C, H)
	).
...
validate_store_type_assumption___1__4(B, J) :-
	...
	(   nb_getval('$chr_store_multi_hash_chr_translate____assumed_store_type___2-1', E),
	    ...
	    delete_ht(H, B, D),
	    setarg(2, G, removed),
	    nb_getval('$chr_store_multi_hash_chr_translate____assumed_store_type___2-1', I),
	    delete_ht(I, B, G),
	    (   var(J)
	    ->  true
	    ;   arg(2, J, K),
	...
	;   nb_getval('$chr_store_multi_hash_chr_translate____store_type___2-1', O),
	    ...
	    setarg(2, D, removed),
	    nb_getval('$chr_store_multi_hash_chr_translate____actual_store_types___2-1', R),
	    delete_ht(R, B, D),
	    setarg(2, Q, removed),
		...
		(   T==not_stored_yet
		->  true
		;   nb_getval('$chr_store_multi_hash_chr_translate____validate_store_type_assumption___1-1', U),
		    delete_ht(U, B, J)
		)
	    ),
	    store_type(B, multi_store(M))
...
passive___2__0__0__6([A|Q], C, F, M) :-
	...
	->  (   setarg(2, A, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____least_occurrence___2-12', J),
...
passive___2__1__0__8([A|J], C, E, K) :-
	(   (   A=suspension(_, active, _, _, G, I, B, D, _),
	    ...
	    lookup_ht(F, G, H)
	->  passive___2__1__1__8(H, G, I, A, J, C, E, K)
...
passive___2__1__1__8([A|U], C, D, V, W, Q, S, N) :-
	...
	->  (   (   setarg(2, A, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-13', I),
	    delete_ht(I, k(C, J), A)
	    ),
	    ...
	    setarg(2, H, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____stored___3-13', L),
	    ...
	    setarg(2, N, active),
	    (   O==not_stored_yet
	    ->  (   nb_getval('$chr_store_multi_hash_chr_translate____passive___2-1', P),
		insert_ht(P, Q, N)
		),
	    ...
	    ->  setarg(2, N, inactive),
		passive___2__1__1__8(U, C, D, V, W, Q, S, N)
	    ;   true
	    )
	;   passive___2__1__1__8(U, C, D, V, W, Q, S, N)
	).
...
passive___2__4__0__11([A|N], C, F, J) :-
	(   A=suspension(_, active, B, D),
	    ...
	    E==F
	->  (   setarg(2, A, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____check_all_passive___2-12', G),
	    delete_ht(G, k(C, [F|H]), A)
	    ),
	    nb_getval('$chr_store_multi_hash_chr_translate____check_all_passive___2-1', I),
	    delete_ht(I, C, A)
	    ),
	    (   arg(2, J, K),
	    setarg(2, J, active),
...
passive___2__5__0__14([A|J], C, E, K) :-
	(   (   A=suspension(_, active, _, _, G, H, B, D, _),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____skip_to_next_id___2-12', F),
	    lookup_ht(F, k(G, H), I)
	->  passive___2__5__1__14(I, G, H, A, J, C, E, K)
...
passive___2__5__1__14([A|O], C, E, F, P, K, M, G) :-
	...
	->  '$extend_history'(G, H),
	    ...
	    ->  setarg(2, G, inactive),
		passive___2__5__1__14(O, C, E, F, P, K, M, G)
	    ;   true
	    )
	;   passive___2__5__1__14(O, C, E, F, P, K, M, G)
	).
...
passive___2__6__0__15([A|J], C, E, K) :-
	(   (   A=suspension(_, active, _, _, G, H, B, D, _),
	    ...
	    lookup_ht(F, k(G, H), I)
	->  passive___2__6__1__15(I, G, H, A, J, C, E, K)
...
passive___2__6__1__15([A|O], C, E, P, Q, J, L, G) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    (   G=suspension(_, active, _, _, _)
	    ->  setarg(2, G, inactive),
		passive___2__6__1__15(O, C, E, P, Q, J, L, G)
	    ;   true
	    )
	;   passive___2__6__1__15(O, C, E, P, Q, J, L, G)
	).
...
new_occurrence(B, H, I, J) :-
	...
	setarg(2, D, removed),
	nb_getval('$chr_store_multi_hash_chr_translate____max_occurrence___2-1', E),
	delete_ht(E, B, D),
	G is F+1,
...
occurrence___5__0(D, E, B, F, G, C) :-
	...
	'chr gen_id'(H),
	occurrence___5__0__0__4(I, D, E, B, F, G, C).
...
occurrence___5__0__0__4([A|I], E, F, C, J, K, L) :-
	(   (   A=suspension(_, active, _, _, B, H),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____allocation_occurrence___2-12', D),
	    lookup_ht(D, k(E, F), G)
	->  occurrence___5__0__1__4(G, H, A, I, E, F, C, J, K, L)
	;   occurrence___5__0__0__4(I, E, F, C, J, K, L)
	).
occurrence___5__0__1__4([], _, _, A, B, C, D, E, F, G) :-
	occurrence___5__0__0__4(A, B, C, D, E, F, G).
occurrence___5__0__1__4([A|Y], X, F, Z, C, E, Q, R, K, G) :-
	...
	->  '$extend_history'(G, H),
	    ...
	    setarg(2, G, active),
	    (   I==not_stored_yet
	    ->  (   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-15', J),
		insert_ht(J, k(C, K), G)
		),
		...
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-125', O),
		insert_ht(O, k(C, E, K), G)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-134', P),
	    ...
	    ->  setarg(2, G, inactive),
		occurrence___5__0__1__4(Y, X, F, Z, C, E, Q, R, K, G)
	    ;   true
	    )
	;   occurrence___5__0__1__4(Y, X, F, Z, C, E, Q, R, K, G)
	).
...
occurrence___5__1(D, E, B, F, G, H) :-
	nb_getval('$chr_store_multi_hash_chr_translate____least_occurrence___2-1', A),
	lookup_ht(A, B, C), !,
	occurrence___5__1__0__7(C, D, E, B, F, G, H).
...
occurrence___5__1__0__7([A|G1], G, L, C, F, V, S) :-
	(   (   A=suspension(_, active, B, D),
	    ...
	    \+ may_trigger(G)
	->  (   setarg(2, A, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____least_occurrence___2-12', P),
	    ...
	    setarg(2, S, active),
	    (   T==not_stored_yet
	    ->  (   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-15', U),
		insert_ht(U, k(G, V), S)
		),
		(   nb_getval('$chr_store_global_ground_chr_translate____occurrence___5', W),
		X=[S|W],
		b_setval('$chr_store_global_ground_chr_translate____occurrence___5', X),
		(   W=[Y|_]
		->  setarg(4, Y, X)
		;   true
		)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-125', Z),
		insert_ht(Z, k(G, L, V), S)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-134', A1),
		insert_ht(A1, k(G, C, F), S)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-12', B1),
		insert_ht(B1, k(G, L), S)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-3', C1),
		insert_ht(C1, C, S)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', D1),
		insert_ht(D1, k(G, C), S)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-34', E1),
		insert_ht(E1, k(C, F), S)
		),
		nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-1', F1),
		insert_ht(F1, G, S)
	    ;   true
	    )
	    ),
	    ...
	    ->  setarg(2, S, inactive),
		occurrence___5__1__0__7(G1, G, L, C, F, V, S)
	    ;   true
	    )
	;   occurrence___5__1__0__7(G1, G, L, C, F, V, S)
	).
...
occurrence___5__2(D, E, B, F, G, H) :-
	nb_getval('$chr_store_multi_hash_chr_translate____set_all_passive___1-1', A),
	lookup_ht(A, B, C), !,
	occurrence___5__2__0__29(C, D, E, B, F, G, H).
...
occurrence___5__2__0__29([A|V], H, N, C, P, I, D) :-
	...
	->  '$extend_history'(D, E),
	    ...
	    setarg(2, D, active),
	    (   F==not_stored_yet
	    ->  (   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-15', G),
		insert_ht(G, k(H, I), D)
		),
		(   nb_getval('$chr_store_global_ground_chr_translate____occurrence___5', J),
		K=[D|J],
		b_setval('$chr_store_global_ground_chr_translate____occurrence___5', K),
		(   J=[L|_]
		->  setarg(4, L, K)
		;   true
		)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-125', M),
		...
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', S),
		insert_ht(S, k(H, C), D)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-34', T),
		insert_ht(T, k(C, P), D)
		),
		nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-1', U),
		insert_ht(U, H, D)
	    ;   true
	    )
	    ),
	    ...
	    ->  setarg(2, D, inactive),
		occurrence___5__2__0__29(V, H, N, C, P, I, D)
	    ;   true
	    )
	;   occurrence___5__2__0__29(V, H, N, C, P, I, D)
	).
...
occurrence___5__3(D, E, B, F, G, H) :-
	nb_getval('$chr_store_multi_hash_chr_translate____rule___2-1', A),
	lookup_ht(A, B, C), !,
	occurrence___5__3__0__30(C, D, E, B, F, G, H).
...
occurrence___5__3__0__30([A|H], E, I, C, J, K, L) :-
	(   (   A=suspension(_, active, _, _, B, G),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', D),
	    lookup_ht(D, k(E, C), F)
	->  occurrence___5__3__1__30(F, G, A, H, E, I, C, J, K, L)
	;   occurrence___5__3__0__30(H, E, I, C, J, K, L)
	).
occurrence___5__3__1__30([], _, _, A, B, C, D, E, F, G) :-
	occurrence___5__3__0__30(A, B, C, D, E, F, G).
occurrence___5__3__1__30([A|I], J, K, L, C, M, E, N, O, P) :-
	(   (   A=suspension(_, active, _, _, B, H, D, _, _),
	    ...
	    lookup_ht(F, E, G)
	->  occurrence___5__3__2__30(G, H, A, I, J, K, L, C, M, E, N, O, P)
	;   occurrence___5__3__1__30(I, J, K, L, C, M, E, N, O, P)
	).
occurrence___5__3__2__30([], _, _, A, B, C, D, E, F, G, H, I, J) :-
	occurrence___5__3__1__30(A, B, C, D, E, F, G, H, I, J).
occurrence___5__3__2__30([A|E], F, G, H, I, J, K, L, M, C, N, O, P) :-
	...
	->  occurrence___5__3__3__30(D, A, E, F, G, H, I, J, K, L, M, C, N, O, P)
	;   occurrence___5__3__2__30(E, F, G, H, I, J, K, L, M, C, N, O, P)
	).
occurrence___5__3__3__30([], _, A, B, C, D, E, F, G, H, I, J, K, L, M) :-
	occurrence___5__3__2__30(A, B, C, D, E, F, G, H, I, J, K, L, M).
occurrence___5__3__3__30([A|C1], D1, E1, C, F1, G1, D, H1, I1, F, B, U, V, O, L) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    setarg(2, L, active),
	    (   M==not_stored_yet
	    ->  (   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-15', N),
		insert_ht(N, k(F, O), L)
		),
		...
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-125', S),
		insert_ht(S, k(F, B, O), L)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-134', T),
		...
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', Y),
		insert_ht(Y, k(F, U), L)
		),
	    ...
	    ->  setarg(2, L, inactive),
		occurrence___5__3__3__30(C1, D1, E1, C, F1, G1, D, H1, I1, F, B, U, V, O, L)
	    ;   true
	    )
	;   occurrence___5__3__3__30(C1, D1, E1, C, F1, G1, D, H1, I1, F, B, U, V, O, L)
	).
...
occurrence___5__4(D, E, B, F, G, H) :-
	nb_getval('$chr_store_multi_hash_chr_translate____rule___2-1', A),
	lookup_ht(A, B, C), !,
	occurrence___5__4__0__31(C, D, E, B, F, G, H).
...
occurrence___5__4__0__31([A|H], E, I, C, J, K, L) :-
	(   (   A=suspension(_, active, _, _, B, G),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', D),
	    lookup_ht(D, k(E, C), F)
	->  occurrence___5__4__1__31(F, G, A, H, E, I, C, J, K, L)
	;   occurrence___5__4__0__31(H, E, I, C, J, K, L)
	).
occurrence___5__4__1__31([], _, _, A, B, C, D, E, F, G) :-
	occurrence___5__4__0__31(A, B, C, D, E, F, G).
occurrence___5__4__1__31([A|J], K, L, M, C, N, E, O, P, Q) :-
	(   (   A=suspension(_, active, _, _, B, H, D, I, _),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____prev_guard_list___6-1', F),
	    lookup_ht(F, E, G)
	->  occurrence___5__4__2__31(G, H, I, A, J, K, L, M, C, N, E, O, P, Q)
	;   occurrence___5__4__1__31(J, K, L, M, C, N, E, O, P, Q)
	).
occurrence___5__4__2__31([], _, _, _, A, B, C, D, E, F, G, H, I, J) :-
	occurrence___5__4__1__31(A, B, C, D, E, F, G, H, I, J).
occurrence___5__4__2__31([A|E], F, G, H, I, J, K, L, M, N, C, O, P, Q) :-
	(   (   A=suspension(_, active, _, _, B, _, _, _, _, _),
	    B==C
	    ),
	    nb_getval('$chr_store_global_ground_chr_translate____multiple_occ_constraints_checked___1', D)
	->  occurrence___5__4__3__31(D, A, E, F, G, H, I, J, K, L, M, N, C, O, P, Q)
	;   occurrence___5__4__2__31(E, F, G, H, I, J, K, L, M, N, C, O, P, Q)
	).
occurrence___5__4__3__31([], _, A, B, C, D, E, F, G, H, I, J, K, L, M, N) :-
	occurrence___5__4__2__31(A, B, C, D, E, F, G, H, I, J, K, L, M, N).
occurrence___5__4__3__31([A|D1], E1, F1, B, B1, G1, H1, D, I1, J1, F, C, U, V, O, L) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    (   L=suspension(_, active, _, _, _, _, _, _, _)
	    ->  setarg(2, L, inactive),
		occurrence___5__4__3__31(D1, E1, F1, B, B1, G1, H1, D, I1, J1, F, C, U, V, O, L)
	    ;   true
	    )
	;   occurrence___5__4__3__31(D1, E1, F1, B, B1, G1, H1, D, I1, J1, F, C, U, V, O, L)
	).
...
occurrence___5__5(B, C, E, F, G, H) :-
	...
	occurrence___5__5__0__35(D, B, C, E, F, G, H).
...
occurrence___5__5__0__35([A|J1], C, E, G, H, X, U) :-
	...
	->  (   (   setarg(2, A, removed),
	    ...
	    setarg(2, N, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-13', R),
	    delete_ht(R, k(C, S), N)
	    ),
	    nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-1', T),
	    delete_ht(T, C, N)
	    ),
	    (   arg(2, U, V),
	    setarg(2, U, active),
	    (   V==not_stored_yet
	    ->  (   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-15', W),
		insert_ht(W, k(C, X), U)
		),
		(   nb_getval('$chr_store_global_ground_chr_translate____occurrence___5', Y),
		Z=[U|Y],
		b_setval('$chr_store_global_ground_chr_translate____occurrence___5', Z),
		(   Y=[A1|_]
		->  setarg(4, A1, Z)
		;   true
		)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-125', B1),
		insert_ht(B1, k(C, E, X), U)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-134', C1),
		insert_ht(C1, k(C, G, H), U)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-12', D1),
		insert_ht(D1, k(C, E), U)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-3', E1),
		insert_ht(E1, G, U)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', F1),
		insert_ht(F1, k(C, G), U)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-34', G1),
		insert_ht(G1, k(G, H), U)
		),
		nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-1', H1),
		insert_ht(H1, C, U)
	    ;   true
	    )
	    ),
	    ...
	    ->  setarg(2, U, inactive),
		occurrence___5__5__0__35(J1, C, E, G, H, X, U)
	    ;   true
	    )
	;   occurrence___5__5__0__35(J1, C, E, G, H, X, U)
	).
...
occurrence___5__6(D, E, B, F, G, H) :-
	nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-3', A),
	lookup_ht(A, B, C), !,
	occurrence___5__6__0__36(C, D, E, B, F, G, H).
...
occurrence___5__6__0__36([A|G], H, I, C, J, K, L) :-
	(   (   A=suspension(_, active, _, _, E, _, B, _, _),
	    ...
	    lookup_ht(D, E, F)
	->  occurrence___5__6__1__36(F, E, A, G, H, I, C, J, K, L)
	;   occurrence___5__6__0__36(G, H, I, C, J, K, L)
	).
occurrence___5__6__1__36([], _, _, A, B, C, D, E, F, G) :-
	occurrence___5__6__0__36(A, B, C, D, E, F, G).
occurrence___5__6__1__36([A|G], C, H, I, J, K, L, M, N, O) :-
	(   (   A=suspension(_, active, _, B, F),
	    B==C
	    ),
	    nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-13', D),
	    lookup_ht(D, k(C, 0), E)
	->  occurrence___5__6__2__36(E, F, A, G, C, H, I, J, K, L, M, N, O)
	;   occurrence___5__6__1__36(G, C, H, I, J, K, L, M, N, O)
	).
occurrence___5__6__2__36([], _, _, A, B, C, D, E, F, G, H, I, J) :-
	occurrence___5__6__1__36(A, B, C, D, E, F, G, H, I, J).
occurrence___5__6__2__36([A|B1], J, G, C1, C, F, D1, M, S, U, V, N, E) :-
	...
	->  '$extend_history'(E, H),
	    ...
	    setarg(2, E, active),
	    (   K==not_stored_yet
	    ->  (   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-15', L),
		insert_ht(L, k(M, N), E)
		),
		...
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-125', R),
	    ...
	    ->  setarg(2, E, inactive),
		occurrence___5__6__2__36(B1, J, G, C1, C, F, D1, M, S, U, V, N, E)
	    ;   true
	    )
	;   occurrence___5__6__2__36(B1, J, G, C1, C, F, D1, M, S, U, V, N, E)
	).
...
occurrence___5__7(D, E, B, F, G, H) :-
	nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-3', A),
	lookup_ht(A, B, C), !,
	occurrence___5__7__0__37(C, D, E, B, F, G, H).
...
occurrence___5__7__0__37([A|H], E, I, C, J, K, L) :-
	(   (   A=suspension(_, active, _, _, _, _, B, G, _),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____max_occurrence___2-1', D),
	    lookup_ht(D, E, F)
	->  occurrence___5__7__1__37(F, G, A, H, E, I, C, J, K, L)
	;   occurrence___5__7__0__37(H, E, I, C, J, K, L)
	).
occurrence___5__7__1__37([], _, _, A, B, C, D, E, F, G) :-
	occurrence___5__7__0__37(A, B, C, D, E, F, G).
occurrence___5__7__1__37([A|G], H, I, J, C, K, L, M, N, O) :-
	(   (   A=suspension(_, active, _, B, F),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-13', D),
	    lookup_ht(D, k(C, 0), E)
	->  occurrence___5__7__2__37(E, F, A, G, H, I, J, C, K, L, M, N, O)
	;   occurrence___5__7__1__37(G, H, I, J, C, K, L, M, N, O)
	).
occurrence___5__7__2__37([], _, _, A, B, C, D, E, F, G, H, I, J) :-
	occurrence___5__7__1__37(A, B, C, D, E, F, G, H, I, J).
occurrence___5__7__2__37([A|B1], J, G, C1, A1, E, D1, C, R, T, U, M, F) :-
	...
	->  '$extend_history'(F, H),
		...
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-125', Q),
		insert_ht(Q, k(C, R, M), F)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-134', S),
	    ...
	    ->  setarg(2, F, inactive),
		occurrence___5__7__2__37(B1, J, G, C1, A1, E, D1, C, R, T, U, M, F)
	    ;   true
	    )
	;   occurrence___5__7__2__37(B1, J, G, C1, A1, E, D1, C, R, T, U, M, F)
	).
...
occurrence___5__8(B, D, E, F, G, H) :-
	nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-1', A),
	lookup_ht(A, B, C), !,
	occurrence___5__8__0__38(C, B, D, E, F, G, H).
...
occurrence___5__8__0__38([A|W], C, F, P, Q, J, D) :-
	...
	->  '$extend_history'(D, E),
	    ...
	    setarg(2, D, active),
	    (   H==not_stored_yet
	    ->  (   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-15', I),
		insert_ht(I, k(C, J), D)
		),
		...
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-125', N),
		...
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-3', S),
		insert_ht(S, P, D)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', T),
		insert_ht(T, k(C, P), D)
		),
	    ...
	    (   D=suspension(_, active, _, _, _, _, _, _, _)
	    ->  setarg(2, D, inactive),
		occurrence___5__8__0__38(W, C, F, P, Q, J, D)
	    ;   true
	    )
	;   occurrence___5__8__0__38(W, C, F, P, Q, J, D)
	).
...
occurrence___5__9(B, E, C, F, G, H) :-
	nb_getval('$chr_store_multi_hash_chr_translate____functional_dependency___4-12', A),
	lookup_ht(A, k(B, C), D), !,
	occurrence___5__9__0__42(D, B, E, C, F, G, H).
...
occurrence___5__9__0__42([A|D1], C, J, E, V, P, M) :-
	(   (   A=suspension(_, active, B, D, B1, C1),
	    ...
	    I>J
	->  (   setarg(2, A, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____functional_dependency___4-1', K),
	    delete_ht(K, C, A)
	    ),
	    nb_getval('$chr_store_multi_hash_chr_translate____functional_dependency___4-12', L),
	    delete_ht(L, k(C, E), A)
	    ),
	    (   arg(2, M, N),
	    setarg(2, M, active),
	    (   N==not_stored_yet
	    ->  (   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-15', O),
		insert_ht(O, k(C, P), M)
		),
		...
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-125', T),
	    ...
	    ->  setarg(2, M, inactive),
		occurrence___5__9__0__42(D1, C, J, E, V, P, M)
	    ;   true
	    )
	;   occurrence___5__9__0__42(D1, C, J, E, V, P, M)
	).
...
occurrence___5__10(B, D, E, F, G, H) :-
	nb_getval('$chr_store_multi_hash_chr_translate____constraint_mode___2-1', A),
	lookup_ht(A, B, C), !,
	occurrence___5__10__0__48(C, B, D, E, F, G, H).
...
occurrence___5__10__0__48([A|F], C, G, H, I, J, K) :-
	(   (   A=suspension(_, active, _, _, B, E),
	    ...
	    nb_getval('$chr_store_global_ground_chr_translate____partial_wake_analysis___0', D)
	->  occurrence___5__10__1__48(D, E, A, F, C, G, H, I, J, K)
	;   occurrence___5__10__0__48(F, C, G, H, I, J, K)
	).
occurrence___5__10__1__48([], _, _, A, B, C, D, E, F, G) :-
	occurrence___5__10__0__48(A, B, C, D, E, F, G).
occurrence___5__10__1__48([A|E], F, G, H, I, J, C, K, L, M) :-
	(   A=suspension(_, active, _, _),
	    nb_getval('$chr_store_multi_hash_chr_translate____rule___2-1', B),
	    lookup_ht(B, C, D)
	->  occurrence___5__10__2__48(D, A, E, F, G, H, I, J, C, K, L, M)
	;   occurrence___5__10__1__48(E, F, G, H, I, J, C, K, L, M)
	).
occurrence___5__10__2__48([], _, A, B, C, D, E, F, G, H, I, J) :-
	occurrence___5__10__1__48(A, B, C, D, E, F, G, H, I, J).
occurrence___5__10__2__48([A|F1], D, G1, C1, F, H1, J, P, C, R, K, E) :-
	...
	->  '$extend_history'(E, G),
	    ...
	    (   E=suspension(_, active, _, _, _, _, _, _, _)
	    ->  setarg(2, E, inactive),
		occurrence___5__10__2__48(F1, D, G1, C1, F, H1, J, P, C, R, K, E)
	    ;   true
	    )
	;   occurrence___5__10__2__48(F1, D, G1, C1, F, H1, J, P, C, R, K, E)
	).
...
occurrence___5__11(E, F, B, C, G, H) :-
	nb_getval('$chr_store_multi_hash_chr_translate____passive___2-12', A),
	lookup_ht(A, k(B, C), D), !,
	occurrence___5__11__0__50(D, E, F, B, C, G, H).
...
occurrence___5__11__0__50([A|J], G, H, C, E, K, L) :-
	(   (   A=suspension(_, active, _, B, D),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____skip_to_next_id___2-12', F),
	    lookup_ht(F, k(G, H), I)
	->  occurrence___5__11__1__50(I, A, J, G, H, C, E, K, L)
	;   occurrence___5__11__0__50(J, G, H, C, E, K, L)
	).
occurrence___5__11__1__50([], _, A, B, C, D, E, F, G) :-
	occurrence___5__11__0__50(A, B, C, D, E, F, G).
occurrence___5__11__1__50([A|Y], G, Z, C, E, Q, R, K, F) :-
	...
	->  '$extend_history'(F, H),
	    ...
	    (   F=suspension(_, active, _, _, _, _, _, _, _)
	    ->  setarg(2, F, inactive),
		occurrence___5__11__1__50(Y, G, Z, C, E, Q, R, K, F)
	    ;   true
	    )
	;   occurrence___5__11__1__50(Y, G, Z, C, E, Q, R, K, F)
	).
...
occurrence___5__12(B, C, E, F, G, H) :-
	nb_getval('$chr_store_multi_hash_chr_translate____set_occurrence_code_id___3-12', A),
	lookup_ht(A, k(B, C), D), !,
	occurrence___5__12__0__51(D, B, C, E, F, G, H).
...
occurrence___5__12__0__51([A|B1], C, E, F, G, O, L) :-
	...
	->  (   setarg(2, A, removed),
		...
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-12', U),
		insert_ht(U, k(C, E), L)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-3', V),
		insert_ht(V, F, L)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', W),
		insert_ht(W, k(C, F), L)
		),
	    ...
	    (   L=suspension(_, active, _, _, _, _, _, _, _)
	    ->  setarg(2, L, inactive),
		occurrence___5__12__0__51(B1, C, E, F, G, O, L)
	    ;   true
	    )
	;   occurrence___5__12__0__51(B1, C, E, F, G, O, L)
	).
...
occurrence___5__13(B, C, E, F, simplification, G) :-
	nb_getval('$chr_store_multi_hash_chr_translate____set_occurrence_code_id___3-12', A),
	lookup_ht(A, k(B, C), D), !,
	occurrence___5__13__0__52(D, B, C, E, F, simplification, G).
...
occurrence___5__13__0__52([A|Y], C, E, P, Q, J, G) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    (   G=suspension(_, active, _, _, _, _, _, _, _)
	    ->  setarg(2, G, inactive),
		occurrence___5__13__0__52(Y, C, E, P, Q, J, G)
	    ;   true
	    )
	;   occurrence___5__13__0__52(Y, C, E, P, Q, J, G)
	).
occurrence___5__13(B, C, E, F, propagation, G) :-
	nb_getval('$chr_store_multi_hash_chr_translate____set_occurrence_code_id___3-12', A),
	lookup_ht(A, k(B, C), D), !,
	occurrence___5__13__0__53(D, B, C, E, F, propagation, G).
...
occurrence___5__13__0__53([A|C1], C, E, S, T, M, J) :-
	(   (   A=suspension(_, active, B, D, Z),
	    ...
	    H=suspension(_, active, _, _, _)
	->  (   setarg(2, A, removed),
	    nb_getval('$chr_store_multi_hash_chr_translate____set_occurrence_code_id___3-12', I),
	    delete_ht(I, k(C, E), A)
	    ),
	    (   arg(2, J, K),
	    setarg(2, J, active),
	    ...
	    ->  setarg(2, J, inactive),
		occurrence___5__13__0__53(C1, C, E, S, T, M, J)
	    ;   true
	    )
	;   occurrence___5__13__0__53(C1, C, E, S, T, M, J)
	).
...
occurrence___5__14(B, C, E, F, propagation, G) :-
	nb_getval('$chr_store_multi_hash_chr_translate____set_occurrence_code_id___3-12', A),
	lookup_ht(A, k(B, C), D), !,
	occurrence___5__14__0__54(D, B, C, E, F, propagation, G).
...
occurrence___5__14__0__54([A|Y], C, E, P, Q, J, G) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    (   G=suspension(_, active, _, _, _, _, _, _, _)
	    ->  setarg(2, G, inactive),
		occurrence___5__14__0__54(Y, C, E, P, Q, J, G)
	    ;   true
	    )
	;   occurrence___5__14__0__54(Y, C, E, P, Q, J, G)
	).
...
occurrence___5__15(D, J, L, M, E, A) :-
	...
	setarg(2, A, active),
	(   B==not_stored_yet
	->  (   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-15', C),
	    insert_ht(C, k(D, E), A)
	    ),
	    (   nb_getval('$chr_store_global_ground_chr_translate____occurrence___5', F),
	    G=[A|F],
	    b_setval('$chr_store_global_ground_chr_translate____occurrence___5', G),
	    (   F=[H|_]
	    ->  setarg(4, H, G)
	    ;   true
	    )
	    ),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-125', I),
...
max_occurrence___2__1__0__5([A|H], C, I, J) :-
	(   (   A=suspension(_, active, _, B, G, D),
	    ...
	    lookup_ht(E, C, F)
	->  max_occurrence___2__1__1__5(F, G, A, H, C, I, J)
...
max_occurrence___2__1__1__5([A|G], H, I, J, C, K, L) :-
	(   (   A=suspension(_, active, _, _, B, _, E, _, _),
	    ...
	    lookup_ht(D, E, F)
	->  max_occurrence___2__1__2__5(F, E, A, G, H, I, J, C, K, L)
	;   max_occurrence___2__1__1__5(G, H, I, J, C, K, L)
	).
max_occurrence___2__1__2__5([], _, _, A, B, C, D, E, F, G) :-
	max_occurrence___2__1__1__5(A, B, C, D, E, F, G).
max_occurrence___2__1__2__5([A|N], D, B, O, H, E, P, L, I, F) :-
	...
	->  '$extend_history'(F, G),
	    ...
	    ->  setarg(2, F, inactive),
		max_occurrence___2__1__2__5(N, D, B, O, H, E, P, L, I, F)
	    ;   true
	    )
	;   max_occurrence___2__1__2__5(N, D, B, O, H, E, P, L, I, F)
	).
...
allocation_occurrence___2__1__0__2([A|K], C, E, L) :-
	(   (   A=suspension(_, active, _, _, B, D, G, I, J),
	    ...
	    lookup_ht(F, G, H)
	->  allocation_occurrence___2__1__1__2(H, G, I, J, A, K, C, E, L)
	;   allocation_occurrence___2__1__0__2(K, C, E, L)
	).
...
allocation_occurrence___2__1__1__2([A|O], C, L, M, D, P, I, K, E) :-
	...
	->  '$extend_history'(E, F),
	    ...
	    (   E=suspension(_, active, _, _, _)
	    ->  setarg(2, E, inactive),
		allocation_occurrence___2__1__1__2(O, C, L, M, D, P, I, K, E)
	    ;   true
	    )
	;   allocation_occurrence___2__1__1__2(O, C, L, M, D, P, I, K, E)
	).
...
allocation_occurrence___2__2__0__3([A|I], C, J, K) :-
	(   (   A=suspension(_, active, _, _, B, G, E, H, _),
	    ...
	    lookup_ht(D, E, F)
	->  allocation_occurrence___2__2__1__3(F, G, E, H, A, I, C, J, K)
	;   allocation_occurrence___2__2__0__3(I, C, J, K)
	).
...
allocation_occurrence___2__2__1__3([A|T], H, C, F, U, V, L, G, P) :-
	(   (   A=suspension(_, active, B, D),
	    ...
	    \+ may_trigger(L)
	->  (   setarg(2, A, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____least_occurrence___2-12', M),
	    delete_ht(M, k(C, [F|N]), A)
	    ),
	    nb_getval('$chr_store_multi_hash_chr_translate____least_occurrence___2-1', O),
	    delete_ht(O, C, A)
	    ),
	    (   arg(2, P, Q),
	    setarg(2, P, active),
	    ...
	    ->  setarg(2, P, inactive),
		allocation_occurrence___2__2__1__3(T, H, C, F, U, V, L, G, P)
	    ;   true
	    )
	;   allocation_occurrence___2__2__1__3(T, H, C, F, U, V, L, G, P)
	).
...
allocation_occurrence___2__3__0__5([A|R], C, H, L) :-
	(   (   A=suspension(_, active, B, D, P, Q),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', E),
	    lookup_ht(E, k(C, D), F)
	    ),
	    'chr sbag_member'(G, F),
	...
	->  (   setarg(2, A, removed),
	    ...
	    ->  setarg(2, L, inactive),
		allocation_occurrence___2__3__0__5(R, C, H, L)
	    ;   true
	    )
	;   allocation_occurrence___2__3__0__5(R, C, H, L)
	).
...
rule___2__0__0__1([A|J], C, K, L) :-
	(   (   A=suspension(_, active, _, _, E, F, B, H, I),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____allocation_occurrence___2-12', D),
	    lookup_ht(D, k(E, F), G)
	->  rule___2__0__1__1(G, E, F, H, I, A, J, C, K, L)
...
rule___2__0__1__1([A|R], C, E, O, P, G, S, N, Q, F) :-
	...
	->  '$extend_history'(F, H),
	    ...
	    (   F=suspension(_, active, _, _, _, _)
	    ->  setarg(2, F, inactive),
		rule___2__0__1__1(R, C, E, O, P, G, S, N, Q, F)
	    ;   true
	    )
	;   rule___2__0__1__1(R, C, E, O, P, G, S, N, Q, F)
	).
...
rule___2__1__0__2([A|X], C, Y, R) :-
	(   (   A=suspension(_, active, B, D),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-34', F),
	    lookup_ht(F, k(C, E), G)
	    ),
	    'chr sbag_member'(H, G),
	    H=suspension(_, active, _, _, J, N, _, _, _)
	    ),
	    (   (   nb_getval('$chr_store_multi_hash_chr_translate____allocation_occurrence___2-1', I),
	    lookup_ht(I, J, K)
	    ),
	    'chr sbag_member'(L, K),
	...
	->  (   setarg(2, A, removed),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____least_occurrence___2-1', Q),
	    delete_ht(Q, C, A)
	    ),
	    (   arg(2, R, S),
	    setarg(2, R, active),
...
rule___2__2__0__3([A|R], C, S, L) :-
	(   (   A=suspension(_, active, B, D),
	    ...
	    H=suspension(_, active, _, _, _)
	->  (   setarg(2, A, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____least_occurrence___2-12', I),
...
rule___2__4(B, E, S) :-
	...
	arg(4, D, N),
	(   var(N)
	->  nb_getval('$chr_store_global_ground_chr_translate____prev_guard_list___6', O),
	    O=[_|P],
	    b_setval('$chr_store_global_ground_chr_translate____prev_guard_list___6', P),
	    (   P=[Q|_]
	    ->  setarg(4, Q, _)
	    ;   true
	    )
	...
	nb_getval('$chr_store_multi_hash_chr_translate____prev_guard_list___6-1', R),
	delete_ht(R, B, D),
	(   var(S)
	->  true
	;   arg(2, S, T),
	...
	rule(B, pragma(rule(Z, A1, M, B1), C1, D1, E1, B)),
...
rule___2__6(B, E, B1) :-
	...
	;   arg(2, B1, C1),
	    ...
	    ;   (   arg(4, B1, D1),
		(   var(D1)
		->  nb_getval('$chr_store_global_ground_chr_translate____rule___2', E1),
		    E1=[_|F1],
		    b_setval('$chr_store_global_ground_chr_translate____rule___2', F1),
		    (   F1=[G1|_]
		    ->  setarg(4, G1, _)
		    ;   true
		    )
		...
		nb_getval('$chr_store_multi_hash_chr_translate____rule___2-1', H1),
		delete_ht(H1, B, B1)
	    )
	),
	rule(B, I1).
...
rule___2__6__0__13([A|H], C, I, J) :-
	(   (   A=suspension(_, active, _, _, E, G, B, _, _),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', D),
	    lookup_ht(D, k(E, C), F)
	->  rule___2__6__1__13(F, E, G, A, H, C, I, J)
...
rule___2__6__1__13([A|K], D, L, B, M, F, N, O) :-
	(   (   A=suspension(_, active, _, _, C, I, E, J, _),
	    ...
	    lookup_ht(G, F, H)
	->  rule___2__6__2__13(H, I, J, A, K, D, L, B, M, F, N, O)
	;   rule___2__6__1__13(K, D, L, B, M, F, N, O)
	).
rule___2__6__2__13([], _, _, _, A, B, C, D, E, F, G, H) :-
	rule___2__6__1__13(A, B, C, D, E, F, G, H).
rule___2__6__2__13([A|E], F, G, H, I, J, K, L, M, C, N, O) :-
	(   (   A=suspension(_, active, _, _, B, _, _, _, _, _),
	    B==C
	    ),
	    nb_getval('$chr_store_global_ground_chr_translate____multiple_occ_constraints_checked___1', D)
	->  rule___2__6__3__13(D, A, E, F, G, H, I, J, K, L, M, C, N, O)
	;   rule___2__6__2__13(E, F, G, H, I, J, K, L, M, C, N, O)
	).
rule___2__6__3__13([], _, A, B, C, D, E, F, G, H, I, J, K, L) :-
	rule___2__6__2__13(A, B, C, D, E, F, G, H, I, J, K, L).
rule___2__6__3__13([A|U], V, W, B, S, X, Y, F, C, Z, A1, R, D, L) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    (   L=suspension(_, active, _, _, _, _)
	    ->  setarg(2, L, inactive),
		rule___2__6__3__13(U, V, W, B, S, X, Y, F, C, Z, A1, R, D, L)
	    ;   true
	    )
	;   rule___2__6__3__13(U, V, W, B, S, X, Y, F, C, Z, A1, R, D, L)
	).
...
rule___2__10__0__22([A|H], C, I, J) :-
	(   (   A=suspension(_, active, _, _, E, _, B, F, G),
	    ...
	    nb_getval('$chr_store_global_ground_chr_translate____partial_wake_analysis___0', D)
	->  rule___2__10__1__22(D, E, F, G, A, H, C, I, J)
...
rule___2__10__1__22([A|E], C, F, G, H, I, J, K, L) :-
	(   A=suspension(_, active, _, _),
	    nb_getval('$chr_store_multi_hash_chr_translate____constraint_mode___2-1', B),
	    lookup_ht(B, C, D)
	->  rule___2__10__2__22(D, A, E, C, F, G, H, I, J, K, L)
	;   rule___2__10__1__22(E, C, F, G, H, I, J, K, L)
	).
rule___2__10__2__22([], _, A, B, C, D, E, F, G, H, I) :-
	rule___2__10__1__22(A, B, C, D, E, F, G, H, I).
rule___2__10__2__22([A|X], D, Y, C, O, P, E, Z, M, N, F) :-
	...
	->  '$extend_history'(F, G),
	    ...
	    (   F=suspension(_, active, _, _, _, _)
	    ->  setarg(2, F, inactive),
		rule___2__10__2__22(X, D, Y, C, O, P, E, Z, M, N, F)
	    ;   true
	    )
	;   rule___2__10__2__22(X, D, Y, C, O, P, E, Z, M, N, F)
	).
...
type_indexed_identifier_index(F, B, C, G) :-
	...
	;    !,
	    type_indexed_identifier_index___4__0__0__2(D, F, B, C, G)
	).
...
type_indexed_identifier_index___4__0__0__2([A|I], J, C, E, K) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    type_indexed_identifier_index___4__0__0__2(I, J, C, E, K)
	;   type_indexed_identifier_index___4__0__0__2(I, J, C, E, K)
	).
...
history___3__0__0__1([A|M], C, K, G, D) :-
	...
	->  '$extend_history'(D, E),
	    ...
	    setarg(2, D, active),
	    (   F==not_stored_yet
	    ->  (   '$chr_store_constants_chr_translate____history___3___[3]'(G, H)
		->  nb_getval(H, I),
		    b_setval(H, [D|I])
		;   true
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____history___3-2', J),
		insert_ht(J, K, D)
		),
...
history___3__2__0__3([A|Q], L, C, G, D) :-
	...
	->  '$extend_history'(D, E),
	    ...
	    ;   test_named_history_id_pairs(L, G, P, M)
	    )
	    ),
	    (   D=suspension(_, active, _, _, _, _)
	    ->  setarg(2, D, inactive),
...
history___3__3__0__4([A|Q], L, C, G, D) :-
	...
	->  '$extend_history'(D, E),
	    ...
	    (   N\==O
	    ->  chr_error(syntax, 'The history named ~w does not always range over an equal amount of occurrences.\n', [C])
	    ;   test_named_history_id_pairs(P, M, L, G)
	    )
	    ),
	    (   D=suspension(_, active, _, _, _, _)
	    ->  setarg(2, D, inactive),
...
history___3__4__0__6([A|L], K, I, E, B) :-
	...
	->  '$extend_history'(B, C),
	    ...
	    setarg(2, B, active),
	    (   D==not_stored_yet
	    ->  (   '$chr_store_constants_chr_translate____history___3___[3]'(E, F)
		->  nb_getval(F, G),
		    b_setval(F, [B|G])
		;   true
		),
...
history___3__5(I, G, C, A) :-
	...
	setarg(2, A, active),
	(   B==not_stored_yet
	->  (   '$chr_store_constants_chr_translate____history___3___[3]'(C, D)
	    ->  nb_getval(D, E),
		b_setval(D, [A|E])
	    ;   true
	    ),
...
named_history(A, E, G) :-
	ground(A),
	nb_getval('$chr_store_multi_hash_chr_translate____history___3-1', B),
	lookup_ht(B, A, C),
	'chr sbag_member'(D, C),
...
spawns___3__0__0__4([A|P], C, Q, F, R) :-
	(   A=suspension(_, active, _, _, B, D, E),
	    ...
	    E==F
	->  (   setarg(2, A, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-13', G),
	    delete_ht(G, k(C, F), A)
	    ),
	    (   arg(4, A, H),
	    (   var(H)
...
spawns___3__1(B, C, I, F) :-
	...
	;   arg(2, F, G),
	    ...
	    (   G==not_stored_yet
	    ->  true
	    ;   (   nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-13', H),
		delete_ht(H, k(B, I), F)
		),
		(   arg(4, F, J),
		(   var(J)
...
spawns___3__1(B, C, F, G) :-
	...
	;   arg(2, G, H),
	    ...
	    (   H==not_stored_yet
	    ->  true
	    ;   (   nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-13', I),
		delete_ht(I, k(B, F), G)
		),
		(   arg(4, G, J),
		(   var(J)
...
spawns___3__1(M, S, B, J) :-
	...
	(   'chr sbag_member'(D, C),
		...
		;   arg(2, J, K),
			...
			delete_ht(V, k(M, S, B), J)
		    )
		),
		spawns_all(M, S)
	    ;   nb_getval('$chr_store_multi_hash_chr_translate____spawns_all_triggers___2-1', W),
		lookup_ht(W, F, X),
		'chr sbag_member'(Y, X),
		...
		;   arg(2, J, Z),
		    ...
		    (   Z==not_stored_yet
		    ->  true
		    ;   (   nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-13', A1),
			delete_ht(A1, k(M, B), J)
			),
			(   arg(4, J, B1),
			(   var(B1)
			->  nb_getval('$chr_store_global_ground_chr_translate____spawns___3', C1),
			    C1=[_|D1],
			    b_setval('$chr_store_global_ground_chr_translate____spawns___3', D1),
			    (   D1=[E1|_]
			    ->  setarg(4, E1, _)
			    ;   true
			    )
			...
			(   nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-12', F1),
			delete_ht(F1, k(M, S), J)
			),
			(   nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-1', G1),
			delete_ht(G1, M, J)
			),
			(   nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-3', H1),
			delete_ht(H1, B, J)
			),
			nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-123', I1),
			delete_ht(I1, k(M, S, B), J)
		    )
		),
...
spawns___3__1__0__11([A|H], I, J, C, K) :-
	(   (   A=suspension(_, active, _, _, B, _, E, G, _),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____spawns_all_triggers___2-1', D),
	    lookup_ht(D, E, F)
	->  spawns___3__1__1__11(F, E, G, A, H, I, J, C, K)
...
spawns___3__1__1__11([A|T], C, H, D, U, K, P, G, E) :-
	...
	->  '$extend_history'(E, F),
	    ...
	    setarg(2, E, active),
	    (   I==not_stored_yet
	    ->  (   nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-13', J),
		insert_ht(J, k(K, G), E)
		),
	    ...
	    (   E=suspension(_, active, _, _, _, _, _)
	    ->  setarg(2, E, inactive),
		spawns___3__1__1__11(T, C, H, D, U, K, P, G, E)
	    ;   true
	    )
	;   spawns___3__1__1__11(T, C, H, D, U, K, P, G, E)
	).
...
spawns___3__2__0__12([A|H], C, I, J, K) :-
	(   (   A=suspension(_, active, _, _, E, _, B, G, _),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-3', D),
	    lookup_ht(D, E, F)
	->  spawns___3__2__1__12(F, E, G, A, H, C, I, J, K)
...
spawns___3__2__1__12([A|V], C, J, E, W, H, Q, I, D) :-
	...
	->  '$extend_history'(D, F),
		...
		(   nb_getval('$chr_store_global_ground_chr_translate____spawns___3', M),
		N=[D|M],
		b_setval('$chr_store_global_ground_chr_translate____spawns___3', N),
		(   M=[O|_]
		->  setarg(4, O, N)
		;   true
		)
		),
		(   nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-12', P),
		insert_ht(P, k(H, Q), D)
		),
	    ...
	    ->  setarg(2, D, inactive),
		spawns___3__2__1__12(V, C, J, E, W, H, Q, I, D)
	    ;   true
	    )
	;   spawns___3__2__1__12(V, C, J, E, W, H, Q, I, D)
	).
...
spawns___3__3__0__13([A|H], I, J, C, K) :-
	(   (   A=suspension(_, active, _, _, B, _, E, G, _),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-1', D),
	    lookup_ht(D, E, F)
	->  spawns___3__3__1__13(F, E, G, A, H, I, J, C, K)
...
spawns___3__3__1__13([A|U], C, J, D, V, G, Q, H, E) :-
	...
	->  '$extend_history'(E, F),
	    ...
	    (   E=suspension(_, active, _, _, _, _, _)
	    ->  setarg(2, E, inactive),
		spawns___3__3__1__13(U, C, J, D, V, G, Q, H, E)
	    ;   true
	    )
	;   spawns___3__3__1__13(U, C, J, D, V, G, Q, H, E)
	).
...
spawns___3__4__0__14([A|G], C, H, I, J) :-
	...
	->  spawns___3__4__1__14(D, E, F, A, G, C, H, I, J)
...
spawns___3__4__1__14([A|U], G, F, C, V, E, O, H, B) :-
	...
	->  '$extend_history'(B, D),
	    ...
	    ->  setarg(2, B, inactive),
		spawns___3__4__1__14(U, G, F, C, V, E, O, H, B)
	    ;   true
	    )
	;   spawns___3__4__1__14(U, G, F, C, V, E, O, H, B)
	).
...
spawns_all___2__1__0__5([A|P], C, E, Q) :-
	(   A=suspension(_, active, _, _, B, D, G),
	    ...
	    D==E
	->  (   setarg(2, A, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-13', F),
	    delete_ht(F, k(C, G), A)
	    ),
	    (   arg(4, A, H),
	    (   var(H)
...
spawns_all___2__2__0__6([A|O], C, P, Q) :-
	(   A=suspension(_, active, _, _, B, D, F),
	    ...
	    D=body
	->  (   setarg(2, A, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-13', E),
	    delete_ht(E, k(C, F), A)
	    ),
	    (   arg(4, A, G),
	    (   var(G)
...
spawns_all___2__5__0__9([A|H], C, I, J) :-
	(   (   A=suspension(_, active, _, _, E, _, B, G, _),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-3', D),
	    lookup_ht(D, E, F)
	->  spawns_all___2__5__1__9(F, E, G, A, H, C, I, J)
...
spawns_all___2__5__1__9([A|V], C, E, W, X, D, U, Q) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    (   Q=suspension(_, active, _, _)
	    ->  setarg(2, Q, inactive),
		spawns_all___2__5__1__9(V, C, E, W, X, D, U, Q)
	    ;   true
	    )
	;   spawns_all___2__5__1__9(V, C, E, W, X, D, U, Q)
	).
...
spawns_all_triggers___2__0__0__4([A|K], C, L, M) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    spawns_all_triggers___2__0__0__4(K, C, L, M)
	;   spawns_all_triggers___2__0__0__4(K, C, L, M)
	).
...
spawns_all_triggers___2__1__0__7([A|P], C, E, Q) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    spawns_all_triggers___2__1__0__7(P, C, E, Q)
	;   spawns_all_triggers___2__1__0__7(P, C, E, Q)
	).
spawns_all_triggers___2__1(A, B, C) :-
	spawns_all_triggers___2__2(A, B, C).
...
spawns_all_triggers___2__2__0__8([A|O], C, P, Q) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    spawns_all_triggers___2__2__0__8(O, C, P, Q)
	;   spawns_all_triggers___2__2__0__8(O, C, P, Q)
	).
spawns_all_triggers___2__2(A, B, C) :-
	spawns_all_triggers___2__3(A, B, C).
...
spawns_all_triggers___2__3__0__10([A|H], C, I, J) :-
	(   (   A=suspension(_, active, _, _, E, _, B, G, _),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-3', D),
	    lookup_ht(D, E, F)
	->  spawns_all_triggers___2__3__1__10(F, E, G, A, H, C, I, J)
...
spawns_all_triggers___2__3__1__10([A|Y], C, E, Z, A1, D, X, Q) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    ->  setarg(2, Q, inactive),
		spawns_all_triggers___2__3__1__10(Y, C, E, Z, A1, D, X, Q)
	    ;   true
	    )
	;   spawns_all_triggers___2__3__1__10(Y, C, E, Z, A1, D, X, Q)
	).
...
spawns_all_triggers___2__4__0__11([A|H], C, I, J) :-
	(   (   A=suspension(_, active, _, _, E, _, B, G, _),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____spawns___3-3', D),
	    lookup_ht(D, E, F)
	->  spawns_all_triggers___2__4__1__11(F, E, G, A, H, C, I, J)
...
spawns_all_triggers___2__4__1__11([A|R], C, H, E, S, G, O, D) :-
	...
	->  '$extend_history'(D, F),
	    ...
	    (   D=suspension(_, active, _, _, _, _)
	    ->  setarg(2, D, inactive),
		spawns_all_triggers___2__4__1__11(R, C, H, E, S, G, O, D)
	    ;   true
	    )
	;   spawns_all_triggers___2__4__1__11(R, C, H, E, S, G, O, D)
	).
...
spawns_all_triggers___2__5__0__12([A|F], G, H, I) :-
	(   A=suspension(_, active, _, _, C, _, E),
	    nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-3', B),
	    lookup_ht(B, C, D)
	->  spawns_all_triggers___2__5__1__12(D, C, E, A, F, G, H, I)
...
spawns_all_triggers___2__5__1__12([A|R], C, I, D, S, O, Q, E) :-
	...
	->  '$extend_history'(E, F),
	    ...
	    (   E=suspension(_, active, _, _, _, _)
	    ->  setarg(2, E, inactive),
		spawns_all_triggers___2__5__1__12(R, C, I, D, S, O, Q, E)
	    ;   true
	    )
	;   spawns_all_triggers___2__5__1__12(R, C, I, D, S, O, Q, E)
	).
...
spawns_all_triggers_implies_spawns_all___0__0__0__3([A|O], J) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    ->  setarg(2, J, inactive),
		spawns_all_triggers_implies_spawns_all___0__0__0__3(O, J)
	    ;   true
	    )
	;   spawns_all_triggers_implies_spawns_all___0__0__0__3(O, J)
	).
...
do_is_observed(B, K, I) :-
	...
	(   (   nb_getval('$chr_store_multi_hash_chr_translate____spawns_all___2-12', J),
		lookup_ht(J, k(K, I), L),
		'chr sbag_member'(M, L),
...
do_is_observed(B, J) :-
	...
	(   (   nb_getval('$chr_store_multi_hash_chr_translate____spawns_all___2-1', I),
		lookup_ht(I, J, K),
		'chr sbag_member'(L, K),
...
generate_indexed_variables_body(B/C, G, H, I) :-
	...
	;   get_constraint_type_det(B/C, K),
	    create_indexed_variables_body(G, J, K, I, 1, B/C, L, M),
	    (   L==empty
	    ->  H=true,
		I=[]
	    ;   M==0
...
generate_empty_named_history_initialisation___1__0(B, A) :-
	...
	generate_empty_named_history_initialisation___1__0__0__3(D, B, A).
...
generate_empty_named_history_initialisation___1__0__0__3([A|T], O, F) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    ->  setarg(2, F, inactive),
		generate_empty_named_history_initialisation___1__0__0__3(T, O, F)
	    ;   true
	    )
	;   generate_empty_named_history_initialisation___1__0__0__3(T, O, F)
	).
...
find_empty_named_histories___0__0(A) :-
	nb_getval('$chr_store_constants_chr_translate____history___3___[3]___[]', C), !,
...
actual_atomic_multi_hash_keys(B, J, O) :-
	nb_getval('$chr_store_multi_hash_chr_translate____actual_store_types___2-1', A),
	lookup_ht(A, B, C),
	'chr sbag_member'(D, C),
	D=suspension(_, active, _, I),
	nb_getval('$chr_store_multi_hash_chr_translate____validate_store_type_assumption___1-1', E),
	lookup_ht(E, B, F),
	'chr sbag_member'(G, F),
	G=suspension(_, active, _), !,
	...
	actual_store_types(B, [atomic_constants(J, N, P)|Q]).
...
actual_atomic_multi_hash_keys(A, B, C) :-
	F=suspension(D, active, A, B, C),
	'chr gen_id'(D),
	nb_getval('$chr_store_multi_hash_chr_translate____actual_atomic_multi_hash_keys___3-12', E),
	insert_ht(E, k(A, B), F),
	nb_getval('$chr_store_multi_hash_chr_translate____actual_atomic_multi_hash_keys___3-1', G),
	insert_ht(G, A, F).
actual_ground_multi_hash_keys(B, I, M) :-
	...
	delete(O, multi_hash([I]), P),
	actual_store_types(B, [ground_constants(I, L, N)|P]).
...
actual_ground_multi_hash_keys(A, B, C) :-
	F=suspension(D, active, A, B, C),
	'chr gen_id'(D),
	nb_getval('$chr_store_multi_hash_chr_translate____actual_ground_multi_hash_keys___3-12', E),
	insert_ht(E, k(A, B), F),
	nb_getval('$chr_store_multi_hash_chr_translate____actual_ground_multi_hash_keys___3-1', G),
	insert_ht(G, A, F).
actual_non_ground_multi_hash_key(B, C) :-
...
actual_non_ground_multi_hash_key___2__0__0__3([A|H], C, E) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    actual_non_ground_multi_hash_key___2__0__0__3(H, C, E)
	;   actual_non_ground_multi_hash_key___2__0__0__3(H, C, E)
	).
...
actual_non_ground_multi_hash_key___2__1__0__4([A|H], C, E) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    actual_non_ground_multi_hash_key___2__1__0__4(H, C, E)
	;   actual_non_ground_multi_hash_key___2__1__0__4(H, C, E)
	).
actual_non_ground_multi_hash_key___2__1(A, B) :-
	actual_non_ground_multi_hash_key___2__2(A, B).
actual_non_ground_multi_hash_key___2__2(A, B) :-
	E=suspension(C, active, A, B),
	'chr gen_id'(C),
	nb_getval('$chr_store_multi_hash_chr_translate____actual_non_ground_multi_hash_key___2-12', D),
	insert_ht(D, k(A, B), E).
symbol_count(A, B) :-
...
symbol_count___2__0(A, T, M) :-
	...
	;   nb_getval('$chr_store_global_list_chr_translate____fresh_symbol___2', D)
	),
	'chr sbag_member'(E, D),
	...
	arg(5, E, H),
	(   var(H)
	->  nb_getval('$chr_store_global_list_chr_translate____fresh_symbol___2', I),
	    I=[_|J],
	    b_setval('$chr_store_global_list_chr_translate____fresh_symbol___2', J),
	    (   J=[K|_]
	    ->  setarg(5, K, _)
	    ;   true
	    )
	...
	;   M=suspension(_, _, _, N, _),
	    ...
	    (   arg(3, M, O),
	    (   var(O)
	    ->  nb_getval('$chr_store_global_list_chr_translate____symbol_count___2', P),
		P=[_|Q],
		b_setval('$chr_store_global_list_chr_translate____symbol_count___2', Q),
		(   Q=[R|_]
		->  setarg(3, R, _)
		;   true
		)
...
symbol_count___2__0(B, C, A) :-
	...
	->  (   A=suspension(D, active, _, B, C),
	    ...
	    (   nb_getval('$chr_store_global_list_chr_translate____symbol_count___2', E),
	    F=[A|E],
	    b_setval('$chr_store_global_list_chr_translate____symbol_count___2', F),
	    (   E=[G|_]
	    ->  setarg(3, G, F)
	    ;   true
	    )
...
fresh_symbol___2__0(A, V, M) :-
	...
	;   nb_getval('$chr_store_global_list_chr_translate____symbol_count___2', D)
	),
	'chr sbag_member'(E, D),
	...
	arg(3, E, H),
	(   var(H)
	->  nb_getval('$chr_store_global_list_chr_translate____symbol_count___2', I),
	    I=[_|J],
	    b_setval('$chr_store_global_list_chr_translate____symbol_count___2', J),
	    (   J=[K|_]
	    ->  setarg(3, K, _)
	    ;   true
	    )
	...
	;   M=suspension(_, N, _, _, _, O, _),
		...
		(   arg(5, M, Q),
		(   var(Q)
		->  nb_getval('$chr_store_global_list_chr_translate____fresh_symbol___2', R),
		    R=[_|S],
		    b_setval('$chr_store_global_list_chr_translate____fresh_symbol___2', S),
		    (   S=[T|_]
		    ->  setarg(5, T, _)
		    ;   true
		    )
...
fresh_symbol___2__1(_, _, A) :-
	...
	->  A=suspension(_, _, _, _, _, E, _),
	    term_variables(E, I),
	    (   nb_getval('$chr_store_global_list_chr_translate____fresh_symbol___2', F),
	    G=[A|F],
	    b_setval('$chr_store_global_list_chr_translate____fresh_symbol___2', G),
	    (   F=[H|_]
	    ->  setarg(5, H, G)
	    ;   true
	    )
...
background_info___2__0__0__1([A|Q], D, O, B) :-
	...
	->  '$extend_history'(B, C),
		...
		term_variables(J, N),
		(   nb_getval('$chr_store_global_list_chr_translate____background_info___2', K),
		L=[B|K],
		b_setval('$chr_store_global_list_chr_translate____background_info___2', L),
		(   K=[M|_]
		->  setarg(5, M, L)
		;   true
		)
...
background_info___2__1(_, _, A) :-
	...
	->  A=suspension(_, _, _, _, _, E, _),
	    term_variables(E, I),
	    (   nb_getval('$chr_store_global_list_chr_translate____background_info___2', F),
	    G=[A|F],
	    b_setval('$chr_store_global_list_chr_translate____background_info___2', G),
	    (   F=[H|_]
	    ->  setarg(5, H, G)
	    ;   true
	    )
...
get_bg_info___2__0(B, C, A) :-
	nb_getval('$chr_store_global_list_chr_translate____background_info___2', E), !,
	(   var(A)
	->  A=suspension(D, not_stored_yet, t, 0, _, B, C),
	    'chr gen_id'(D)
	;   true
...
get_bg_info___2__0__0__1([A|Q], F, R, B) :-
	...
	->  '$extend_history'(B, C),
	    ...
	    ->  B=suspension(_, _, _, _, _, J, _),
		term_variables(J, N),
		(   nb_getval('$chr_store_global_list_chr_translate____get_bg_info___2', K),
		L=[B|K],
		b_setval('$chr_store_global_list_chr_translate____get_bg_info___2', L),
		(   K=[M|_]
		->  setarg(5, M, L)
		;   true
		)
...
get_bg_info___2__1(_, O, G) :-
	...
	;   G=suspension(_, H, _, _, _, I, _),
		...
		(   arg(5, G, K),
		(   var(K)
		->  nb_getval('$chr_store_global_list_chr_translate____get_bg_info___2', L),
		    L=[_|M],
		    b_setval('$chr_store_global_list_chr_translate____get_bg_info___2', M),
		    (   M=[N|_]
		    ->  setarg(5, N, _)
		    ;   true
		    )
...
get_bg_info___2__1(_, I, A) :-
	...
	;   A=suspension(_, B, _, _, _, C, _),
		...
		(   arg(5, A, E),
		(   var(E)
		->  nb_getval('$chr_store_global_list_chr_translate____get_bg_info___2', F),
		    F=[_|G],
		    b_setval('$chr_store_global_list_chr_translate____get_bg_info___2', G),
		    (   G=[H|_]
		    ->  setarg(5, H, _)
		    ;   true
		    )
...
prev_guard_list(W, B, V, H, Z, Q, O, P) :-
	...
	setof(I, chr_translate:head_subset(G, H, I), K), !,
	append(F, J, M),
	compute_derived_info(K, L, G, M, N, O, H, P, R, T),
	append(Q, R, S),
	normalize_conj_list(S, A1),
	append(T, P, U),
	normalize_conj_list(U, B1),
	next_prev_rule(V, X, Y),
	prev_guard_list(W, X, Y, H, Z, A1, O, B1).
...
prev_guard_list___6__0(B, Y, F, H, G, A1, Z) :-
	...
	(   'chr sbag_member'(D, C),
	    ...
	    delete_ht(R, B, D),
	    rule(B, pragma(rule(S, T, M, U), V, W, X, B)),
	    prev_guard_list(B, Y, M, H, G, [])
	;    !,
	    Z=suspension(B1, not_stored_yet, t, _, B, Y, F, H, G, A1),
	    'chr gen_id'(B1),
	    prev_guard_list___6__0__0__3(C, B, Y, F, H, G, A1, Z)
	).
...
prev_guard_list___6__0__0__3([A|R], C, S, G, I, H, T, D) :-
	...
	->  '$extend_history'(D, E),
	    ...
	    setarg(2, D, active),
	    (   M==not_stored_yet
	    ->  (   nb_getval('$chr_store_global_ground_chr_translate____prev_guard_list___6', N),
		O=[D|N],
		b_setval('$chr_store_global_ground_chr_translate____prev_guard_list___6', O),
		(   N=[P|_]
		->  setarg(4, P, O)
		;   true
		)
	    ...
	    ->  setarg(2, D, inactive),
		prev_guard_list___6__0__0__3(R, C, S, G, I, H, T, D)
	    ;   true
	    )
	;   prev_guard_list___6__0__0__3(R, C, S, G, I, H, T, D)
	).
...
prev_guard_list___6__1(B, D, E, F, G, H, I) :-
	nb_getval('$chr_store_multi_hash_chr_translate____rule___2-1', A),
	lookup_ht(A, B, C), !,
	prev_guard_list___6__1__0__4(C, B, D, E, F, G, H, I).
...
prev_guard_list___6__1__0__4([A|M1], C, L, E, G, F, N1, F1) :-
	...
	->  (   setarg(2, A, removed),
		...
		prev_guard_list___6__1__0__4(M1, C, L, E, G, F, N1, F1)
	    ;   true
	    )
	;   prev_guard_list___6__1__0__4(M1, C, L, E, G, F, N1, F1)
	).
...
prev_guard_list___6__2(B, D, E, F, G, H, I) :-
	nb_getval('$chr_store_multi_hash_chr_translate____rule___2-1', A),
	lookup_ht(A, B, C), !,
	prev_guard_list___6__2__0__5(C, B, D, E, F, G, H, I).
...
prev_guard_list___6__2__0__5([A|G], C, H, I, J, K, L, M) :-
	(   (   A=suspension(_, active, _, _, B, F),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-3', D),
	    lookup_ht(D, C, E)
	->  prev_guard_list___6__2__1__5(E, F, A, G, C, H, I, J, K, L, M)
	;   prev_guard_list___6__2__0__5(G, C, H, I, J, K, L, M)
	).
prev_guard_list___6__2__1__5([], _, _, A, B, C, D, E, F, G, H) :-
	prev_guard_list___6__2__0__5(A, B, C, D, E, F, G, H).
prev_guard_list___6__2__1__5([A|H], I, J, K, C, L, M, N, O, P, Q) :-
	(   (   A=suspension(_, active, _, _, E, G, B, _, _),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', D),
	    lookup_ht(D, k(E, C), F)
	->  prev_guard_list___6__2__2__5(F, E, G, A, H, I, J, K, C, L, M, N, O, P, Q)
	;   prev_guard_list___6__2__1__5(H, I, J, K, C, L, M, N, O, P, Q)
	).
prev_guard_list___6__2__2__5([], _, _, _, A, B, C, D, E, F, G, H, I, J, K) :-
	prev_guard_list___6__2__1__5(A, B, C, D, E, F, G, H, I, J, K).
prev_guard_list___6__2__2__5([A|J], D, K, B, L, M, N, O, F, P, Q, R, S, T, U) :-
	...
	->  prev_guard_list___6__2__3__5(G, H, I, A, J, D, K, B, L, M, N, O, F, P, Q, R, S, T, U)
	;   prev_guard_list___6__2__2__5(J, D, K, B, L, M, N, O, F, P, Q, R, S, T, U)
	).
prev_guard_list___6__2__3__5([], _, _, _, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O) :-
	prev_guard_list___6__2__2__5(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O).
prev_guard_list___6__2__3__5([A|U], B, S, V, W, F, C, X, Y, D, Z, A1, R, B1, C1, D1, E1, F1, L) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    ->  setarg(2, L, inactive),
		prev_guard_list___6__2__3__5(U, B, S, V, W, F, C, X, Y, D, Z, A1, R, B1, C1, D1, E1, F1, L)
	    ;   true
	    )
	;   prev_guard_list___6__2__3__5(U, B, S, V, W, F, C, X, Y, D, Z, A1, R, B1, C1, D1, E1, F1, L)
	).
...
simplify_guards(B) :-
	...
	append(K, L, M),
	findall(tuple(N, O, B)- (-B), (member(P, M), get_occurrence_from_id(N, O, B, P)), Q),
	empty_q(R),
	insert_list_q(Q, R, S),
	next_prev_rule(S, _, T),
	next_prev_rule(T, U, V),
	prev_guard_list(B, U, V, W, J, [], X, [Y]),
	Z is B+1,
	simplify_guards(Z).
simplify_guards(_).
set_all_passive(A) :-
...
next_occ_in_rule(B, F, K, L, _, M) :-
	...
	nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-134', E),
...
next_occ_in_rule(B, I, M, T, Y, U) :-
	...
	nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', H),
	lookup_ht(H, k(I, B), J),
	'chr sbag_member'(K, J),
	...
	append(P, Q, R),
	add_failing_occ(N, R, S, T, W, U, V, I, B1),
	(   W==[chr_pp_void_info]
	->  next_occ_in_rule(B, I, L, X, Y, U)
	;   append(W, Y, F1),
	    add_failing_occ(N, R, S, X, N1, U, V, I, C1),
	    copy_term(Z, A1),
	    ...
	    append(J1, K1, M1),
	    append([chr_pp_active_constraint(U)|L1], M1, O1),
	    list2conj(N1, P1),
	    copy_term((F1, K1, O1, P1, U), (_, _, Q1, R1, _)),
	    (   P1\=chr_pp_void_info
...
multiple_occ_constraints_checked(R) :-
	...
	(   nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-3', C),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', J),
	    lookup_ht(J, k(K, D), L),
	    'chr sbag_member'(M, L),
	...
	;    !,
	    ...
	    arg(4, B, U),
	    (   var(U)
	    ->  nb_getval('$chr_store_global_ground_chr_translate____prev_guard_list___6', V),
		V=[_|W],
		b_setval('$chr_store_global_ground_chr_translate____prev_guard_list___6', W),
		(   W=[X|_]
		->  setarg(4, X, _)
		;   true
		)
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____prev_guard_list___6-1', Y),
	    delete_ht(Y, D, B)
	).
...
type_definition___2__0(C, _, N) :-
	...
	(   functor(C, E, F),
	    ...
	    arg(5, B, I),
	    (   var(I)
	    ->  nb_getval('$chr_store_global_list_chr_translate____type_definition___2', J),
		J=[_|K],
		b_setval('$chr_store_global_list_chr_translate____type_definition___2', K),
		(   K=[L|_]
		->  setarg(5, L, _)
		;   true
		)
		...
		;   term_variables(term(P, Q), R),
		    (   arg(5, N, S),
		    (   var(S)
		    ->  nb_getval('$chr_store_global_list_chr_translate____type_definition___2', T),
			T=[_|U],
			b_setval('$chr_store_global_list_chr_translate____type_definition___2', U),
			(   U=[V|_]
			->  setarg(5, V, _)
			;   true
			)
	...
	;   functor(D, W, X),
		...
		;   term_variables(term(G1, H1), I1),
		    (   arg(5, N, J1),
		    (   var(J1)
		    ->  nb_getval('$chr_store_global_list_chr_translate____type_definition___2', K1),
			K1=[_|L1],
			b_setval('$chr_store_global_list_chr_translate____type_definition___2', L1),
			(   L1=[M1|_]
			->  setarg(5, M1, _)
			;   true
			)
...
type_alias___2__0(C, Y, N) :-
	...
	(   'chr sbag_member'(B, A),
		...
		;   functor(D, A1, B1),
		    ...
		    arg(5, B, E1),
		    (   var(E1)
		    ->  nb_getval('$chr_store_global_list_chr_translate____type_alias___2', F1),
			F1=[_|G1],
			b_setval('$chr_store_global_list_chr_translate____type_alias___2', G1),
			(   G1=[H1|_]
			->  setarg(5, H1, _)
			;   true
			)
			...
			;   term_variables(term(K1, L1), M1),
			    (   arg(5, N, N1),
			    (   var(N1)
			    ->  nb_getval('$chr_store_global_list_chr_translate____type_alias___2', O1),
				O1=[_|P1],
				b_setval('$chr_store_global_list_chr_translate____type_alias___2', P1),
				(   P1=[Q1|_]
				->  setarg(5, Q1, _)
				;   true
				)
	    ...
	    ;   functor(D, T1, U1),
		functor(Y, T1, U1),
		copy_term_nat((C, Y, D, Z), (F2, W1, V1, G2)),
		subsumes(V1, W1), !,
		(   var(N)
		->  true
		;   N=suspension(_, X1, _, _, _, Y1, Z1),
			...
			(   arg(5, N, B2),
			(   var(B2)
			->  nb_getval('$chr_store_global_list_chr_translate____type_alias___2', C2),
			    C2=[_|D2],
			    b_setval('$chr_store_global_list_chr_translate____type_alias___2', D2),
			    (   D2=[E2|_]
			    ->  setarg(5, E2, _)
			    ;   true
			    )
...
type_alias___2__0__0__7([A|C1], B, G, Q) :-
	(   A=suspension(_, active, _, _, _, F, C),
	    functor(B, D, E),
	    functor(C, D, E),
	    copy_term_nat((F, C, B, G), (A1, I, H, B1)),
	    subsumes(H, I)
...
type_alias___2__2__0__12([A|A1], B, V, L) :-
	...
	->  (   A=suspension(_, _, _, _, _, F, _),
	    ...
	    (   arg(3, A, G),
	    (   var(G)
	    ->  nb_getval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', H),
		H=[_|I],
		b_setval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', I),
		(   I=[J|_]
		->  setarg(3, J, _)
		;   true
		)
...
constraint_type___2__0(B, C, A) :-
	nb_getval('$chr_store_global_ground_chr_translate____static_type_check___2', E), !,
...
constraint_type___2__0__0__2([A|L], H, I, B) :-
	...
	->  (   arg(2, B, C),
	    ...
	    forall((member(J, I), sub_term(J, K)), (get_type_definition(K, _)->true;chr_error(type_error, 'Undefined type "~w" used in type declaration of "~w".\n', [K, H]))),
...
constraint_type___2__1(G, _, A) :-
	...
	->  (   nb_getval('$chr_store_global_ground_chr_translate____constraint_type___2', C),
	    D=[A|C],
	    b_setval('$chr_store_global_ground_chr_translate____constraint_type___2', D),
	    (   C=[E|_]
	    ->  setarg(3, E, D)
	    ;   true
	    )
...
static_type_check___2__0(B, C, A) :-
	nb_getval('$chr_store_global_ground_chr_translate____constraint_type___2', E), !,
	A=suspension(D, not_stored_yet, _, B, C),
	'chr gen_id'(D),
...
static_type_check___2__0__0__1([A|K], L, M, B) :-
	...
	->  (   arg(2, B, C),
	    setarg(2, B, active),
	    (   C==not_stored_yet
	    ->  nb_getval('$chr_store_global_ground_chr_translate____static_type_check___2', D),
		E=[B|D],
		b_setval('$chr_store_global_ground_chr_translate____static_type_check___2', E),
		(   D=[F|_]
		->  setarg(3, F, E)
		;   true
		)
	    ...
	    forall((member(H, G), sub_term(H, I)), (get_type_definition(I, _)->true;chr_error(type_error, 'Undefined type "~w" used in type declaration of "~w".\n', [I, J]))),
	    (   B=suspension(_, active, _, _, _)
	    ->  setarg(2, B, inactive),
...
ast_static_type_check_term(E, A, D) :-
	nonvar(A),
	A=var(B, C), !,
	ast_static_type_check_var(B, var(B, C), D, E).
...
ast_static_type_check_var___4__0(O, P, D, R, G) :-
	...
	;   G=suspension(_, _, _, _, _, H, _),
	    ...
	    (   arg(3, G, I),
	    (   var(I)
	    ->  nb_getval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', J),
		J=[_|K],
		b_setval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', K),
		(   K=[L|_]
		->  setarg(3, L, _)
		;   true
		)
...
ast_static_type_check_var___4__0(I, J, A, K, B) :-
	...
	;   B=suspension(_, _, _, _, _, C, _),
	    ...
	    (   arg(3, B, D),
	    (   var(D)
	    ->  nb_getval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', E),
		E=[_|F],
		b_setval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', F),
		(   F=[G|_]
		->  setarg(3, G, _)
		;   true
		)
	...
	ast_static_atomic_builtin_type_check_var(I, J, A, K).
...
ast_static_type_check_var___4__0(D, T, E, U, M) :-
	...
	(   E\==F, !,
	    ...
	    arg(3, B, H),
	    (   var(H)
	    ->  nb_getval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', I),
		I=[_|J],
		b_setval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', J),
		(   J=[K|_]
		->  setarg(3, K, _)
		;   true
		)
		...
		(   arg(3, M, O),
		(   var(O)
		->  nb_getval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', P),
		    P=[_|Q],
		    b_setval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', Q),
		    (   Q=[R|_]
		    ->  setarg(3, R, _)
		    ;   true
		    )
	    ...
	    throw(type_error(type_clash(T, U, V, E, F)))
	;   F\==E, !,
	    ...
	    arg(3, B, X),
	    (   var(X)
	    ->  nb_getval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', Y),
		Y=[_|Z],
		b_setval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', Z),
		(   Z=[A1|_]
		->  setarg(3, A1, _)
		;   true
		)
		...
		(   arg(3, M, D1),
		(   var(D1)
		->  nb_getval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', E1),
		    E1=[_|F1],
		    b_setval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', F1),
		    (   F1=[G1|_]
		    ->  setarg(3, G1, _)
		    ;   true
		    )
	    ...
	    throw(type_error(type_clash(I1, V, U, F, E)))
	).
ast_static_type_check_var___4__0(B, C, D, E, A) :-
	...
	->  (   A=suspension(F, active, _, B, C, D, E),
	    ...
	    (   nb_getval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', G),
	    H=[A|G],
	    b_setval('$chr_store_global_list_chr_translate____ast_static_type_check_var___4', H),
	    (   G=[I|_]
	    ->  setarg(3, I, H)
	    ;   true
	    )
...
ast_static_atomic_builtin_type_check_var(B, F, C, G) :-
	...
	(   'chr sbag_member'(E, D),
	    E=suspension(_, active, _, _, _, _), !
	;    !,
	    ast_static_atomic_builtin_type_check_var___4__0__0__3(D, B, F, C, G)
	).
...
ast_static_atomic_builtin_type_check_var___4__0__0__3([A|H], C, I, E, J) :-
	(   A=suspension(_, active, B, _, D, _),
	    ...
	    D==E
	->  (   setarg(2, A, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-1', F),
	    delete_ht(F, C, A)
	    ),
	    nb_getval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-13', G),
	    delete_ht(G, k(C, E), A)
	    ),
	    ast_static_atomic_builtin_type_check_var___4__0__0__3(H, C, I, E, J)
	;   ast_static_atomic_builtin_type_check_var___4__0__0__3(H, C, I, E, J)
	).
...
ast_static_atomic_builtin_type_check_var___4__1(B, D, float, E) :-
	...
	ast_static_atomic_builtin_type_check_var___4__1__0__5(C, B, D, float, E).
...
ast_static_atomic_builtin_type_check_var___4__1__0__5([A|G], C, H, I, J) :-
	(   A=suspension(_, active, B, _, D, _),
	    ...
	    D=number
	->  (   setarg(2, A, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-1', E),
	    delete_ht(E, C, A)
	    ),
	    nb_getval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-13', F),
	    delete_ht(F, k(C, number), A)
	    ),
	    ast_static_atomic_builtin_type_check_var___4__1__0__5(G, C, H, I, J)
	;   ast_static_atomic_builtin_type_check_var___4__1__0__5(G, C, H, I, J)
	).
ast_static_atomic_builtin_type_check_var___4__1(A, B, C, D) :-
...
ast_static_atomic_builtin_type_check_var___4__2(B, D, int, E) :-
	nb_getval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-13', A),
	lookup_ht(A, k(B, number), C), !,
	ast_static_atomic_builtin_type_check_var___4__2__0__7(C, B, D, int, E).
...
ast_static_atomic_builtin_type_check_var___4__2__0__7([A|G], C, H, I, J) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    ast_static_atomic_builtin_type_check_var___4__2__0__7(G, C, H, I, J)
	;   ast_static_atomic_builtin_type_check_var___4__2__0__7(G, C, H, I, J)
	).
ast_static_atomic_builtin_type_check_var___4__2(A, B, C, D) :-
...
ast_static_atomic_builtin_type_check_var___4__3(B, D, natural, E) :-
	nb_getval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-13', A),
	lookup_ht(A, k(B, number), C), !,
	ast_static_atomic_builtin_type_check_var___4__3__0__9(C, B, D, natural, E).
...
ast_static_atomic_builtin_type_check_var___4__3__0__9([A|G], C, H, I, J) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    ast_static_atomic_builtin_type_check_var___4__3__0__9(G, C, H, I, J)
	;   ast_static_atomic_builtin_type_check_var___4__3__0__9(G, C, H, I, J)
	).
ast_static_atomic_builtin_type_check_var___4__3(A, B, C, D) :-
...
ast_static_atomic_builtin_type_check_var___4__4(B, D, dense_int, E) :-
	nb_getval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-13', A),
	lookup_ht(A, k(B, number), C), !,
	ast_static_atomic_builtin_type_check_var___4__4__0__11(C, B, D, dense_int, E).
...
ast_static_atomic_builtin_type_check_var___4__4__0__11([A|G], C, H, I, J) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    ast_static_atomic_builtin_type_check_var___4__4__0__11(G, C, H, I, J)
	;   ast_static_atomic_builtin_type_check_var___4__4__0__11(G, C, H, I, J)
	).
ast_static_atomic_builtin_type_check_var___4__4(A, B, C, D) :-
	ast_static_atomic_builtin_type_check_var___4__5(A, B, C, D).
...
ast_static_atomic_builtin_type_check_var___4__5(B, D, natural, E) :-
	nb_getval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-13', A),
	lookup_ht(A, k(B, int), C), !,
	ast_static_atomic_builtin_type_check_var___4__5__0__13(C, B, D, natural, E).
...
ast_static_atomic_builtin_type_check_var___4__5__0__13([A|G], C, H, I, J) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    ast_static_atomic_builtin_type_check_var___4__5__0__13(G, C, H, I, J)
	;   ast_static_atomic_builtin_type_check_var___4__5__0__13(G, C, H, I, J)
	).
ast_static_atomic_builtin_type_check_var___4__5(A, B, C, D) :-
	ast_static_atomic_builtin_type_check_var___4__6(A, B, C, D).
...
ast_static_atomic_builtin_type_check_var___4__6(B, D, dense_int, E) :-
	nb_getval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-13', A),
	lookup_ht(A, k(B, int), C), !,
	ast_static_atomic_builtin_type_check_var___4__6__0__15(C, B, D, dense_int, E).
...
ast_static_atomic_builtin_type_check_var___4__6__0__15([A|G], C, H, I, J) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    ast_static_atomic_builtin_type_check_var___4__6__0__15(G, C, H, I, J)
	;   ast_static_atomic_builtin_type_check_var___4__6__0__15(G, C, H, I, J)
	).
ast_static_atomic_builtin_type_check_var___4__6(A, B, C, D) :-
	ast_static_atomic_builtin_type_check_var___4__7(A, B, C, D).
...
ast_static_atomic_builtin_type_check_var___4__7(B, D, dense_int, E) :-
	nb_getval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-13', A),
	lookup_ht(A, k(B, natural), C), !,
	ast_static_atomic_builtin_type_check_var___4__7__0__17(C, B, D, dense_int, E).
...
ast_static_atomic_builtin_type_check_var___4__7__0__17([A|G], C, H, I, J) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    ast_static_atomic_builtin_type_check_var___4__7__0__17(G, C, H, I, J)
	;   ast_static_atomic_builtin_type_check_var___4__7__0__17(G, C, H, I, J)
	).
ast_static_atomic_builtin_type_check_var___4__7(A, B, C, D) :-
	ast_static_atomic_builtin_type_check_var___4__8(A, B, C, D).
...
ast_static_atomic_builtin_type_check_var___4__8(A, B, C, D) :-
	...
	nb_getval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-1', F),
	insert_ht(F, A, G),
	nb_getval('$chr_store_multi_hash_chr_translate____ast_static_atomic_builtin_type_check_var___4-13', H),
	insert_ht(H, k(A, C), G).
dynamic_type_check :-
...
dynamic_type_check___0__2(A) :-
	...
	findall(('$dynamic_type_check'(G, H):-I), (atomic_builtin_type(G, H, I);compound_builtin_type(G, H, I, _)), J),
...
atomic_type___1__0(C, G) :-
	...
	;   G=suspension(_, _, _, H),
	    ...
	    (   arg(3, G, I),
	    (   var(I)
	    ->  nb_getval('$chr_store_global_list_chr_translate____atomic_type___1', J),
		J=[_|K],
		b_setval('$chr_store_global_list_chr_translate____atomic_type___1', K),
		(   K=[L|_]
		->  setarg(3, L, _)
		;   true
		)
...
stored(B, C, yes) :-
	...
	C<N, !,
	setarg(2, M, removed),
	nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-13', O),
	delete_ht(O, k(B, P), M),
...
stored(B, E, yes) :-
	...
	E<F,
	nb_getval('$chr_store_multi_hash_chr_translate____ai_not_observed___2-12', G),
	lookup_ht(G, k(B, E), H),
	'chr sbag_member'(I, H),
	I=suspension(_, active, _, _), !,
	setarg(2, D, removed),
	nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-13', J),
	delete_ht(J, k(B, K), D),
	nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-1', L),
	delete_ht(L, B, D),
	M is K-1,
...
stored(A, B, C) :-
	F=suspension(D, active, A, B, C),
	'chr gen_id'(D),
	nb_getval('$chr_store_multi_hash_chr_translate____stored___3-13', E),
	insert_ht(E, k(A, C), F),
...
stored_complete___3__0(B, F, Q, _) :-
	...
	N=suspension(_, active, _, _, _), !,
	setarg(2, N, removed),
	nb_getval('$chr_store_multi_hash_chr_translate____stored___3-13', O),
...
stored_complete___3__0(B, F, L, _) :-
	...
	I=suspension(_, active, _, _), !,
	setarg(2, D, removed),
	nb_getval('$chr_store_multi_hash_chr_translate____stored___3-13', J),
	delete_ht(J, k(B, yes), D),
	nb_getval('$chr_store_multi_hash_chr_translate____stored___3-123', K),
...
stored_complete___3__0__0__3([A|G], C, H, I, J) :-
	(   (   A=suspension(_, active, _, B, F),
	    ...
	    lookup_ht(D, C, E)
	->  stored_complete___3__0__1__3(E, F, A, G, C, H, I, J)
	;   stored_complete___3__0__0__3(G, C, H, I, J)
	).
...
stored_complete___3__0__1__3([A|G], H, I, J, C, K, L, M) :-
	(   (   A=suspension(_, active, _, _, B, _, E, _, _),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-3', D),
	    lookup_ht(D, E, F)
	->  stored_complete___3__0__2__3(F, E, A, G, H, I, J, C, K, L, M)
	;   stored_complete___3__0__1__3(G, H, I, J, C, K, L, M)
	).
stored_complete___3__0__2__3([], _, _, A, B, C, D, E, F, G, H) :-
	stored_complete___3__0__1__3(A, B, C, D, E, F, G, H).
stored_complete___3__0__2__3([A|P], D, B, Q, I, F, R, L, H, M, E) :-
	...
	->  '$extend_history'(E, G),
	    ...
	    setarg(2, E, active),
	    (   J==not_stored_yet
	    ->  (   nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-13', K),
		insert_ht(K, k(L, M), E)
		),
	    ...
	    (   E=suspension(_, active, _, _, _, _)
	    ->  setarg(2, E, inactive),
		stored_complete___3__0__2__3(P, D, B, Q, I, F, R, L, H, M, E)
	    ;   true
	    )
	;   stored_complete___3__0__2__3(P, D, B, Q, I, F, R, L, H, M, E)
	).
...
stored_complete___3__1__0__4([A|N], C, G, J, D) :-
	...
	->  '$extend_history'(D, E),
	    ...
	    (   D=suspension(_, active, _, _, _, _)
	    ->  setarg(2, D, inactive),
		stored_complete___3__1__0__4(N, C, G, J, D)
	    ;   true
	    )
	;   stored_complete___3__1__0__4(N, C, G, J, D)
	).
...
stored_complete___3__2(D, _, E, A) :-
	...
	setarg(2, A, active),
	(   B==not_stored_yet
	->  (   nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-13', C),
	    insert_ht(C, k(D, E), A)
	    ),
	    nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-1', F),
	    insert_ht(F, D, A)
...
is_stored(A) :-
	...
	nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-13', E),
	lookup_ht(E, k(A, 0), F),
	'chr sbag_member'(G, F),
...
is_finally_stored(A) :-
	...
	'chr sbag_member'(D, C),
	D=suspension(_, active, _, _, I),
	nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-1', E),
	lookup_ht(E, A, F),
	'chr sbag_member'(G, F),
	G=suspension(_, active, _, _, H, _),
	H=<I, !,
...
check_all_passive(A, B) :-
	E=suspension(C, active, A, B),
	'chr gen_id'(C),
	nb_getval('$chr_store_multi_hash_chr_translate____check_all_passive___2-12', D),
	insert_ht(D, k(A, B), E),
	nb_getval('$chr_store_multi_hash_chr_translate____check_all_passive___2-1', F),
	insert_ht(F, A, E).
...
occurrence_code(B, C, L, K, M, N) :-
	...
	;   nb_getval('$chr_store_multi_hash_chr_translate____rule___2-1', O),
	    ...
	    (   select2(H, U, S, T, W, V)
	    ->  K=L,
		head1_code(U, H, V, W, R, B, C, L, M, N)
	    ;   select2(H, Z, X, Y, B1, A1)
	    ->  head2_code(Z, H, A1, B1, R, B, C, L, M, C1),
		(   should_skip_to_next_id(B, C)
		->  inc_id(L, K),
		    (   unconditional_occurrence(B, C)
		    ->  C1=N
		    ;   gen_alloc_inc_clause(B, C, L, C1, N)
		    )
		;   K=L,
		    C1=N
		)
...
functional_dependency(C, A, K, L) :-
	...
	'chr sbag_member'(E, D),
	E=suspension(_, active, _, _, I),
	nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-13', F),
	lookup_ht(F, k(C, A), G),
	'chr sbag_member'(H, G),
...
initial_call_pattern___1__1__0__4([A|F], C, G) :-
	...
	->  initial_call_pattern___1__1__1__4(D, E, A, F, C, G)
...
initial_call_pattern___1__1__1__4([A|G], F, C, H, I, B) :-
	...
	->  '$extend_history'(B, D),
	    ...
	    (   B=suspension(_, active, _, _)
	    ->  setarg(2, B, inactive),
		initial_call_pattern___1__1__1__4(G, F, C, H, I, B)
	    ;   true
	    )
	;   initial_call_pattern___1__1__1__4(G, F, C, H, I, B)
	).
...
call_pattern_worker(odom(occ(B, E), G)) :-
	...
	D=suspension(_, active, _, _, F),
	E>F, !,
	final_answer_pattern(odom(occ(B, E), G), odom([], G)).
...
call_pattern_worker(odom(occ(B, C), I)) :-
	...
	J=odom(occ(B, H), I),
	call_pattern(J),
	final_answer_pattern(odom(occ(B, C), I), odom([], I)),
...
call_pattern_worker(odom(occ(B, C), H)) :-
	...
	(   lookup_ht(A, k(B, C, simplification), D),
	    ...
	    E=suspension(_, active, _, _, _, _, F, G, _),
	    \+ is_passive(F, G), !,
	    ai_observation_memo_simplification_rest_heads(B, C, I),
	    ...
	    M=odom(occ(B, L), H),
	    call_pattern(M),
	    depends_on_as(odom(occ(B, C), H), odom(J, K), M),
	    final_answer_pattern(odom(occ(B, C), H), odom([], H))
	;   lookup_ht(A, k(B, C, propagation), N),
	    'chr sbag_member'(O, N),
	    O=suspension(_, active, _, _, _, _, P, Q, _),
	    \+ is_passive(P, Q), !,
	    ai_observation_memo_propagation_rest_heads(B, C, R),
	    ...
	    X=odom(occ(B, W), H),
	    call_pattern(X),
	    depends_on_ap(odom(occ(B, C), H), odom(T, U), X, V)
	).
...
final_answer_pattern___2__1__0__3([A|E], C, F, G) :-
	(   (   A=suspension(_, active, _, B),
	    ...
	    nb_getval('$chr_store_global_ground_chr_translate____abstract_constraints___1', D)
	->  final_answer_pattern___2__1__1__3(D, A, E, C, F, G)
...
final_answer_pattern___2__1__1__3([A|J], B, K, G, I, C) :-
	...
	->  '$extend_history'(C, D),
	    ...
	    ->  setarg(2, C, inactive),
		final_answer_pattern___2__1__1__3(J, B, K, G, I, C)
	    ;   true
	    )
	;   final_answer_pattern___2__1__1__3(J, B, K, G, I, C)
	).
...
final_answer_pattern___2__3__0__5([A|G], C, H, I) :-
	(   (   A=suspension(_, active, _, E, B),
	    ...
	    lookup_ht(D, E, F)
	->  final_answer_pattern___2__3__1__5(F, E, A, G, C, H, I)
...
final_answer_pattern___2__3__1__5([A|G], C, H, I, J, K, L) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    final_answer_pattern___2__3__1__5(G, C, H, I, J, K, L)
	;   final_answer_pattern___2__3__1__5(G, C, H, I, J, K, L)
	).
final_answer_pattern___2__3(A, B, C) :-
	final_answer_pattern___2__4(A, B, C).
...
final_answer_pattern___2__4__0__6([A|M], C, I, D) :-
	...
	->  '$extend_history'(D, E),
	    ...
	    (   D=suspension(_, active, _, _, _)
	    ->  setarg(2, D, inactive),
		final_answer_pattern___2__4__0__6(M, C, I, D)
	    ;   true
	    )
	;   final_answer_pattern___2__4__0__6(M, C, I, D)
	).
...
final_answer_pattern___2__5__0__7([A|H], C, I, J) :-
	(   (   A=suspension(_, active, _, G, B, E),
	    ...
	    lookup_ht(D, E, F)
	->  final_answer_pattern___2__5__1__7(F, G, E, A, H, C, I, J)
...
final_answer_pattern___2__5__1__7([A|N], L, C, D, O, I, J, E) :-
	...
	->  '$extend_history'(E, F),
	    ...
	    (   E=suspension(_, active, _, _, _)
	    ->  setarg(2, E, inactive),
		final_answer_pattern___2__5__1__7(N, L, C, D, O, I, J, E)
	    ;   true
	    )
	;   final_answer_pattern___2__5__1__7(N, L, C, D, O, I, J, E)
	).
...
final_answer_pattern___2__6__0__8([A|H], C, I, J) :-
	(   (   A=suspension(_, active, _, G, E, B),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____final_answer_pattern___2-1', D),
	    lookup_ht(D, E, F)
	->  final_answer_pattern___2__6__1__8(F, G, E, A, H, C, I, J)
...
final_answer_pattern___2__6__1__8([A|N], L, C, D, O, I, K, E) :-
	...
	->  '$extend_history'(E, F),
	    ...
	    (   E=suspension(_, active, _, _, _)
	    ->  setarg(2, E, inactive),
		final_answer_pattern___2__6__1__8(N, L, C, D, O, I, K, E)
	    ;   true
	    )
	;   final_answer_pattern___2__6__1__8(N, L, C, D, O, I, K, E)
	).
...
final_answer_pattern___2__8__0__10([A|I], C, J, K) :-
	(   (   A=suspension(_, active, _, G, B, E, H),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____final_answer_pattern___2-1', D),
	    lookup_ht(D, E, F)
	->  final_answer_pattern___2__8__1__10(F, G, E, H, A, I, C, J, K)
	;   final_answer_pattern___2__8__0__10(I, C, J, K)
	).
...
final_answer_pattern___2__8__1__10([A|T], J, C, N, D, U, I, K, E) :-
	...
	->  '$extend_history'(E, F),
	    ...
	    (   E=suspension(_, active, _, _, _)
	    ->  setarg(2, E, inactive),
		final_answer_pattern___2__8__1__10(T, J, C, N, D, U, I, K, E)
	    ;   true
	    )
	;   final_answer_pattern___2__8__1__10(T, J, C, N, D, U, I, K, E)
	).
...
final_answer_pattern___2__9__0__11([A|I], C, J, K) :-
	(   (   A=suspension(_, active, _, G, E, B, H),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____final_answer_pattern___2-1', D),
	    lookup_ht(D, E, F)
	->  final_answer_pattern___2__9__1__11(F, G, E, H, A, I, C, J, K)
	;   final_answer_pattern___2__9__0__11(I, C, J, K)
	).
...
final_answer_pattern___2__9__1__11([A|T], J, C, N, D, U, I, R, E) :-
	...
	->  '$extend_history'(E, F),
	    ...
	    (   E=suspension(_, active, _, _, _)
	    ->  setarg(2, E, inactive),
		final_answer_pattern___2__9__1__11(T, J, C, N, D, U, I, R, E)
	    ;   true
	    )
	;   final_answer_pattern___2__9__1__11(T, J, C, N, D, U, I, R, E)
	).
...
depends_on_ap___4__0(D, E, B, F, C) :-
	...
	'chr gen_id'(G),
	depends_on_ap___4__0__0__1(H, D, E, B, F, C).
...
depends_on_ap___4__0__0__1([A|L], J, H, C, M, D) :-
	...
	->  '$extend_history'(D, E),
	    ...
	    (   D=suspension(_, active, _, _, _, _, _)
	    ->  setarg(2, D, inactive),
		depends_on_ap___4__0__0__1(L, J, H, C, M, D)
	    ;   true
	    )
	;   depends_on_ap___4__0__0__1(L, J, H, C, M, D)
	).
...
depends_on_ap___4__1(D, B, E, F, G) :-
	nb_getval('$chr_store_multi_hash_chr_translate____final_answer_pattern___2-1', A),
	lookup_ht(A, B, C), !,
	depends_on_ap___4__1__0__2(C, D, B, E, F, G).
...
depends_on_ap___4__1__0__2([A|H], I, C, E, J, K) :-
	(   (   A=suspension(_, active, _, B, G),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____final_answer_pattern___2-1', D),
	    lookup_ht(D, E, F)
	->  depends_on_ap___4__1__1__2(F, G, A, H, I, C, E, J, K)
	;   depends_on_ap___4__1__0__2(H, I, C, E, J, K)
	).
depends_on_ap___4__1__1__2([], _, _, A, B, C, D, E, F) :-
	depends_on_ap___4__1__0__2(A, B, C, D, E, F).
depends_on_ap___4__1__1__2([A|U], L, B, V, K, I, D, O, E) :-
	...
	->  '$extend_history'(E, F),
	    ...
	    (   E=suspension(_, active, _, _, _, _, _)
	    ->  setarg(2, E, inactive),
		depends_on_ap___4__1__1__2(U, L, B, V, K, I, D, O, E)
	    ;   true
	    )
	;   depends_on_ap___4__1__1__2(U, L, B, V, K, I, D, O, E)
	).
...
depends_on_goal___2__0__0__1([A|K], C, D, L) :-
	(   (   A=suspension(_, active, _, B, J),
	    ...
	    (   ground(D),
	    nb_getval('$chr_store_multi_hash_chr_translate____final_answer_pattern___2-1', E),
	    lookup_ht(E, D, F)
	    ),
	    'chr sbag_member'(G, F),
	    G=suspension(_, active, _, _, _)
	->  (   setarg(2, A, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____depends_on___2-1', H),
	    delete_ht(H, C, A)
	    ),
	    nb_getval('$chr_store_multi_hash_chr_translate____depends_on___2-2', I),
	    delete_ht(I, J, A)
...
ai_not_observed___2__0__0__1([A|T], C, E, P) :-
	(   (   A=suspension(_, active, B, D, F),
	    ...
	    (   (   ground(C),
	    nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-1', G),
	    lookup_ht(G, C, H)
	    ),
	    'chr sbag_member'(I, H),
	...
	->  (   (   setarg(2, A, removed),
	    ...
	    setarg(2, I, removed),
	    (   nb_getval('$chr_store_multi_hash_chr_translate____stored_complete___3-13', M),
	    delete_ht(M, k(C, N), I)
	    ),
	    ...
	    setarg(2, P, active),
	    (   Q==not_stored_yet
	    ->  nb_getval('$chr_store_multi_hash_chr_translate____ai_not_observed___2-12', R),
		insert_ht(R, k(C, E), P)
	    ;   true
	    )
	    ),
...
depends_on_as___3__0__0__1([A|H], I, C, E, J) :-
	(   (   A=suspension(_, active, _, B, G),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____final_answer_pattern___2-1', D),
	    lookup_ht(D, E, F)
	->  depends_on_as___3__0__1__1(F, G, A, H, I, C, E, J)
	;   depends_on_as___3__0__0__1(H, I, C, E, J)
	).
...
depends_on_as___3__0__1__1([A|O], K, B, P, M, J, D, E) :-
	...
	->  '$extend_history'(E, F),
	    ...
	    (   E=suspension(_, active, _, _, _, _)
	    ->  setarg(2, E, inactive),
		depends_on_as___3__0__1__1(O, K, B, P, M, J, D, E)
	    ;   true
	    )
	;   depends_on_as___3__0__1__1(O, K, B, P, M, J, D, E)
	).
...
ai_observation_memo_simplification_rest_heads(B, C, V) :-
	...
	nb_getval('$chr_store_global_ground_chr_translate____abstract_constraints___1', J),
	'chr sbag_member'(K, J),
	...
	append(S, T, U),
	sort(U, V),
	ai_observation_memoed_simplification_rest_heads(B, C, V).
...
ai_observation_memo_abstract_goal(B, M) :-
	...
	ai_observation_abstract_goal_(H, I, J, K, L, N),
	M=N,
...
partial_wake_analysis___0__0__0__1([A|H], I) :-
	(   A=suspension(_, active, _, _, C, _, E, F, G),
	    nb_getval('$chr_store_multi_hash_chr_translate____constraint_mode___2-1', B),
	    lookup_ht(B, C, D)
	->  partial_wake_analysis___0__0__1__1(D, C, E, F, G, A, H, I)
...
partial_wake_analysis___0__0__1__1([A|H], C, E, I, J, K, L, M) :-
	(   (   A=suspension(_, active, _, _, B, G),
	    ...
	    lookup_ht(D, E, F)
	->  partial_wake_analysis___0__0__2__1(F, G, A, H, C, E, I, J, K, L, M)
	;   partial_wake_analysis___0__0__1__1(H, C, E, I, J, K, L, M)
	).
partial_wake_analysis___0__0__2__1([], _, _, A, B, C, D, E, F, G, H) :-
	partial_wake_analysis___0__0__1__1(A, B, C, D, E, F, G, H).
partial_wake_analysis___0__0__2__1([A|W], S, F, X, U, C, M, N, E, Y, D) :-
	...
	->  '$extend_history'(D, G),
	    ...
	    (   D=suspension(_, active, _, _)
	    ->  setarg(2, D, inactive),
		partial_wake_analysis___0__0__2__1(W, S, F, X, U, C, M, N, E, Y, D)
	    ;   true
	    )
	;   partial_wake_analysis___0__0__2__1(W, S, F, X, U, C, M, N, E, Y, D)
	).
...
uses_state___2__0__0__3([A|F], C, D, G) :-
	(   A=suspension(_, active, _),
	    nb_getval('$chr_store_multi_hash_chr_translate____if_used_state___5-12', B),
	    lookup_ht(B, k(C, D), E)
	->  uses_state___2__0__1__3(E, A, F, C, D, G)
...
uses_state___2__0__1__3([A|P], Q, R, C, E, K) :-
	...
	->  (   setarg(2, A, removed),
	    ...
	    ->  setarg(2, K, inactive),
		uses_state___2__0__1__3(P, Q, R, C, E, K)
	    ;   true
	    )
	;   uses_state___2__0__1__3(P, Q, R, C, E, K)
	).
...
used_states_known___0__0__0__1([A|S], L) :-
	(   A=suspension(_, active, _, B, C, R, _, Q),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____uses_state___2-12', D),
	    lookup_ht(D, k(B, C), E)
	    ),
	    'chr sbag_member'(F, E),
	    F=suspension(_, active, _, _)
	->  (   setarg(2, A, removed),
	    ...
	    setarg(2, L, active),
	    (   M==not_stored_yet
	    ->  nb_getval('$chr_store_global_ground_chr_translate____used_states_known___0', N),
		O=[L|N],
		b_setval('$chr_store_global_ground_chr_translate____used_states_known___0', O),
		(   N=[P|_]
		->  setarg(3, P, O)
		;   true
		)
...
never_stored_default___2__0__0__1([A|U], D, O, I) :-
	...
	->  (   setarg(2, A, removed),
	    arg(3, A, E),
	    (   var(E)
	    ->  nb_getval('$chr_store_global_ground_chr_translate____never_stored_rules___2', F),
		F=[_|G],
		b_setval('$chr_store_global_ground_chr_translate____never_stored_rules___2', G),
		(   G=[H|_]
		->  setarg(3, H, _)
		;   true
		)
	    ...
	    setarg(2, I, active),
	    (   J==not_stored_yet
	    ->  nb_getval('$chr_store_multi_hash_chr_translate____never_stored_default___2-1', K),
		insert_ht(K, D, I)
	    ;   true
	    )
	    ),
	    ...
	    (   I=suspension(_, active, _, _)
	    ->  setarg(2, I, inactive),
		never_stored_default___2__0__0__1(U, D, O, I)
	    ;   true
	    )
	;   never_stored_default___2__0__0__1(U, D, O, I)
	).
...
continuation_occurrence(A, B, C) :-
	F=suspension(D, active, A, B, C),
	'chr gen_id'(D),
	nb_getval('$chr_store_multi_hash_chr_translate____continuation_occurrence___3-12', E),
	insert_ht(E, k(A, B), F).
...
skip_to_next_id___2__0__0__4([A|J], C, E, K) :-
	(   (   A=suspension(_, active, _, _, B, D, G, H, _),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____passive___2-12', F),
	    lookup_ht(F, k(G, H), I)
	->  skip_to_next_id___2__0__1__4(I, G, H, A, J, C, E, K)
...
skip_to_next_id___2__0__1__4([A|N], C, E, F, O, L, I, G) :-
	...
	->  '$extend_history'(G, H),
	    ...
	    (   G=suspension(_, active, _, _, _)
	    ->  setarg(2, G, inactive),
		skip_to_next_id___2__0__1__4(N, C, E, F, O, L, I, G)
	    ;   true
	    )
	;   skip_to_next_id___2__0__1__4(N, C, E, F, O, L, I, G)
	).
...
skip_to_next_id___2__1__0__5([A|P], C, E, J) :-
	(   (   A=suspension(_, active, B, D, M),
	    ...
	    nb_getval('$chr_store_multi_hash_chr_translate____occurrence___5-125', F),
...
set_occurrence_code_id(B, C, F) :-
	...
	(   (   lookup_ht(A, k(B, C, simplification), D),
		...
		nb_getval('$chr_store_multi_hash_chr_translate____skip_to_next_id___2-12', J),
		lookup_ht(J, k(B, C), K),
		'chr sbag_member'(L, K),
		L=suspension(_, active, _, _, _), !,
		occurrence_code_id(B, C, F),
...
occurrence_code_id(A, B, C) :-
	F=suspension(D, active, A, B, C),
	'chr gen_id'(D),
	nb_getval('$chr_store_multi_hash_chr_translate____occurrence_code_id___3-12', E),
	insert_ht(E, k(A, B), F).
...
chr_constants(A) :-
	C=suspension(B, active, _, A),
	'chr gen_id'(B),
	nb_getval('$chr_store_global_ground_chr_translate____chr_constants___1', D),
	E=[C|D],
	b_setval('$chr_store_global_ground_chr_translate____chr_constants___1', E),
	(   D=[F|_]
	->  setarg(3, F, E)
	;   true
	).
...
print_chr_constants___0__0(A) :-
	nb_getval('$chr_store_global_ground_chr_translate____chr_constants___1', C), !,
	A=suspension(B, not_stored_yet, _),
	'chr gen_id'(B),
...
print_chr_constants___0__1(A) :-
	...
	;   arg(2, A, B),
	    ...
	    ;   arg(3, A, C),
		(   var(C)
		->  nb_getval('$chr_store_global_ground_chr_translate____print_chr_constants___0', D),
		    D=[_|E],
		    b_setval('$chr_store_global_ground_chr_translate____print_chr_constants___0', E),
		    (   E=[F|_]
		    ->  setarg(3, F, _)
		    ;   true
		    )
